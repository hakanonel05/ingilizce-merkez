...
export const PASSAGES_DATA: Passage[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "In many places, kisses are used hello. If you are in Europe or South America, you will see lots of these greeting kisses. But the kissing customs for greeting people are from country to country, and traveling to new places can be confusing if don't know them. Many European men and women say hello with two kisses, one on each cheek. But three kisses are polite in Belgium, and young people in Paris often prefer four, in these countries, you must the right cheek. Starting with your left cheek would be as awkward as sticking out your left hand for a handshake. A variation on the cheek kiss is found in Brazil. When women meet, they put their cheeks together and kiss the air. In some, men kiss each other on the cheeks at business meetings. It's like saying hands. In some parts of the world, people don't kiss when they meet each other. In fact, kissing in public is considered polite In Japan and China, for example, people in public places rarely kiss each other, In most Middle Eastern countries, men and women do not kiss in public, either.",
      "Kisses aren't just for saying hello; people kiss for lots of other reasons as well. For example, a kiss can also of respect. Some people show respect by kissing religious articles and plans Others kiss the ground when they come home to a country they love. Europeans and Latin Americans also use kisses to say beautiful\\! They kiss their fingertips when they see a pretty woman, an expensive car, or a great soccer play. In other places, people say good- bye by kissing their fingertips and blowing the kiss away. Kisses are associated with, too. The French started the custom of kissing their words for good luck before playing. and today, some people kiss a pair of dice before they role them. The English kisses hurt fingers to make them better, as do today. And, of course, people also kiss to make up after a fight.",
      "What are the customs for kissing people in your country? Do you kiss your relatives when you visit them? Do you kiss your friends hello when? Is it polite to kiss someone in public places in your country? All of these kissing customs depend on where in the world you are. Kissing may seem as universal as language, but in fact, kissing customs differ around the world."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "now tattoos are popular with all kinds of people and it's normal to have a tattoo these days.",
      "However, tattoos are not modern. In fact, they are very old in human history. For example, archaeologists found a human in ice from 5000 years ago. He had 57 tattoos on his back, ankles, legs, knees and feet. They were used for many different reasons, In ancient Egypt, people put on tattoos because ‘beautiful’. But in ancient Rome, tattoos were negative and put on criminals and prisoners. In India, tattoos were religious.",
      "In the 16\" and 17\" century, European sailors arrived vit in the islands of Polynesia. They saw tattoos for the first time. The people on the islands had tattoos on their shoulders, These backs and legs. Often the tattoos were designs of features like a river or a mountain. The European sailors liked them and tattoos. And so the idea travelled to Europe. Tattoos in Polynesia are still important today. They give information about, their island or their job.",
      "So is there a connection between traditional tattoos and fashionable tattoos? And can you call tattoos a fashion? Chris Rainier of National Geographic is an expert in tattoos. So, he studies the tattoos in detail but he designs tattoos, too. His book Ancient Marks has photos of tattoos from all over the world. Those photos were taken by his friend David Knight — a world famous photographer. He thinks people in modern societies often have tattoos because they are a connection with®@ traditional world. vit the text. According to paragraph 1, most people do NOT NOT have tattoos of ----."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "‘ail The Plastiki looks like other boats or yachts in Sydney harbour. It's 18 m long, 6 m wide and it weighs about 12000 kg. It carries a crew of 6 people EGItiIM® and has an average speed of 5 knots, However, when to the Plastiki, you DEL realise there's a difference. It's made of 12500 recycled plastic bottles.",
      "One day, the environmentalist David De Rothschild was reading some information about in the seas and Ocean He couldn't believe what he was reading. For example, humans throw away four out of every five plastic bottles that they use and plastic rubbish causes about fight per cent of the pollution in the sea. Soon afterwards, Rothschild decided that he wanted to help the fight against pollution in the sea. To create publicity for the problem, he started building a boat made of plastic bottles so that everyone would / will learn and care about it.",
      "As well as building the boat with recycled plastic, it was important for the boat environmentally-friendly. It uses wind power and solar energy. The crew make meals with garden at the back of the boat. Eğirim e6trim They can do exercise by using the special exercise bicycle. The energy For the bike provides power for the computers. And if take a shower, the boat's shower uses saltwater from the sea.",
      "De Rothschild sailed the Plastiki across the Pacific Ocean from San Francisco to Sydney. That's 15372 nautical kilometres. On the way, De Rothschild took the special boat through the Great Garbage Patch’, lt is a huge area in the Pacific with 3.5 billion",
      "kilogrammes of rubbish. You can see every rubbish here: shoes, toys, bags, toothbrushes, but the worst problem is the plastic. It kills birds and sea life.",
      "The journey wasn't always easy and De Rothschild and his crew had to during storms. There were giant ocean waves and winds of took 129 days. Originally, De Rothschild thought the boat could only travel once but well that he is planning to sail it again one day."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "bold words or expressions.",
      "Did you know that animals are also know that animals are also just contact with each other? Bees communicate by contact with each other? Bees communicate dancing. dancing. Whales talk to each other by singing. And Whales talk each other singing, And same apes talk to humans by using American Sign Same apes talk humans using American Sign Language.",
      "Meet Koko a female gorilla born at the San Francisco Zoo on July 4th, 1971. Koko learned sign language from, Dr. Penny Patterson. Patterson began teaching sign language to Koko in 1972, when Koko was one year old. Koko was a good student for sure, so she moved to the Stanford University campus with Dr. Patterson. Koko continued to learn on the campus until 1976. That's when full-time with Patterson group, the Gorilla Foundation. The relationship between Patterson and Koko has blossomed ever since,",
      "Dr. Patterson says that Koko has mastered sign Patterson says that Koko has mastered sign language. language. She says that Koko knows over 1,000 She says that Koko knows over 1,000 words, words, and that Koko makes up new words. For example For and that Koko makes new For example example / if, Koko didn't know the sign for ring, so Koko didn't know the sign for ring, she she signed the words finger and bracelet. Dr. signed the words finger and bracelet. Patterson Patterson thinks that this shows meaningful and thinks that this shows meaningful and constructive constructive use of language. use language.",
      "Not everyone agrees with. Patterson. Not everyone agrees with. Patterson. Some argue that apes like Koko do not understand the meaning of what they are doing. Skeptics say that the meaning of what they are doing. Skeptics say that vit these apes are just performing complex thinks For example, if an apple and signs red or apple, Dr. Patterson will give her an apple. They argue that Koko does not really know what means. She only knows that if she makes the right motion, then apple. The debate is unsolved, but for certain: Koko is an extraordinary ape."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Unlike, Google wasn't the first company to invent their product. Lycos released their search engine in 1993. Yahoo\\! came out in 1994. AltaVista began serving results in 1995. Google did not come out until years later, in 1998. Although a few years difference may not seem like much, this is a major advantage in the fast moving world of tech. So how did Google do it? How did they overtake their competitors who leaders in time and money? Maybe one good idea made all the difference.",
      "There are millions and millions of sites on the internet, How does a search engine know which ones are relevant to? This is a question that great ninds have worked on for decades. To understand how gama, you need to know how search engines worked in 1998. Back then most at the words in your query. They counted how many times those words appeared on pages. Then they showed pages where the words in your query appeared the most, This system did not work well and people often had to click through pages and pages of with results to find what they wanted Google was the first search engine that began considering links. Links are those blue underlined words that take you to other click on them. Larry Page, cofounder of Google, believed that meaningful data could be drawn from how those links connect Page figured that websites with many links that point at them were more important than those that had few. He was right. Google search results were much rivals. They soon became the world's most used search engine.",
      "You know that you're doing something big when becomes a verb. Ask Xerox, In 1959 they created the first plain paper come machine. It was one of the most. The company name Xerox grew into a verb that means \"to come as in \"Bob, can you Xerox this for me?\". Around 50 years later, the same thing happened to Google. Their company name grew into a verb that means to do an internet search. Now everyone and their grandma know what it means to Google it"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "If we tried to, could we really transform the frozen surface of Mars into something more friendly — a E¢itim place where? And equally importantly, should we?",
      "The first question has a clear answer: Yes, we probably could. NASA planetary scientist Chris McKay says, “Most of the work in 'terraforming' (making it similar to Earth) would be done by. We wouldn't have to build Mars, just modify its atmosphere”, “If we warmed it up and the in some seeds, plants would\".",
      "Robert Zubrin, an engineer and president of the Mars Society, dreams of Martian cities. He thinks one day, we will in Mars! Zubrin believes civilisation cannot succeed if it doesn't expand limitlessiy. He also thinks that if we transformed Mars, we might learn to manage our limited Earth better. He also says, if he was an astronaut, he wouldn't volunteer for journey!",
      "YEAR ZERO: The thousand-year project might begin with a series of eighteen-month survey missions. Each make the six-month journey from Earth to Mars would add a En small habitation module to the base.",
      "100 YEARS: We could make an Earth-like atmosphere. First, we would release the carbon dioxide which is now ice. Maybe mirrors could focus sunlight on the ice to do this.",
      "200 YEARS: With, 200 YEARS: With For enough carbon dioxide, the temperature would go up and rain would fall. Algae and microbes could survive and transform the rocky surface.",
      "600 YEARS: Flowering plants could be introduced would add oxygen to. Forests might even grow."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Many people prefer \"junk food\" to healthy food because taste for it. However, trans fat raises the bad cholesterol in your body and lowers the good body needs. Fatty foods do more than cause obesity. Trans fats build up in the body and blood blood Food to the heart, People whose high percentage of trans fats are at risk for heart diseases.",
      "Trans-fatis made by adding hydrogen te liquid oil. Food companies and restaurants use trans-fat oil as itis inexpensive and makes food last longer. It also improves the taste and texture of, They became very popular in the second half of the 20th century. This is when butter got a bad name. a bad name. By health care professionals, people were told margarine instead which was made from trans fats.",
      "Today doctors know how dangerous these processed foods are. In countries such as the US and Canada there are new government restrictions on food production. Food and beverage makes have to labels to their EĞirim products. These have products. These have a list of dally list of daily recommendations and give details about all otc ingredients including the amount of trans-fats in a product. New York City banned trans fats from all. Even fast food chains such @axin (Marin as McDonalds are being forced to change their theirs recipes. In Europe, food manufacturers have theirs recipes. In Europe, food manufacturers have started using a voluntary labelling system at the consumers’ request.",
      "We all need some fat in our diet. There are three We all need some fat in our diet. There are three different types of fats: saturated fats, trans fats, and unsaturated fats. Doctors recommend that when we get most of our fatty calories from unsaturated fats. Neither butter nor margarine fit in this category, though there are some spreads that contains zero trans fats. Labels are a good way to foods, but a better way is to avoid eating out."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "These days there are pills for just about everything. If you can't sleep, take a pill. If you're unhappy, take a pill. What about if you're overweight and you don't have time to exercise? A new fitness pill may soon until rGitim { soon be available. Scientists are developing a pill that provides the same benefits as exercise, According to a BBC report, the fitness pill will \"build muscles increase stamina, and even.\"",
      "Would you take a pill if it meant you no longer needed the treadmill? Researchers found that mice who took these pills could run long-distances without under without previous training. The test mice also ran almost twice as far. There is evidence that humans on these pills will also be able to build muscles without exercising. Furthermore, the research suggests that those who exercise and take the fitness pill will be even stronger.",
      "Some researchers think the fitness pill will be useful in certain situations. People who cannot get out of bed due to ill health may benefit from the drug. There are also patients whose diseases cause their muscles waste away. Those with as well. Other researchers feel that the average adult might benefit from such a drug. Most adults do not get the 40 minutes of daily exercise that. The fitness pill requires no time.",
      "The greatest concern about the fitness pill is in the sports world. Some will be tempted to use this drug to enhance performance. The pill has not been approved for human use yet, however, some athletes may already be taking it. Top athletes already go through extensive drug testing before testing before events. The renowned gold medalist swimmer, Michael Phelps, voluntarily went through extra drug testing before the 2008 Olympics. He wanted to prove to the public that his strength comes from hard work and training before the world became skeptical, the text. What does “stamina” in paragraph 1 is closest in meaning to ----.?"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Which is the most successful animal live today? Is it the in stretching in the midday African sun, or is it some insect reproducing, deep in the Amazon rainforest? A good argument could be made for humans themselves. But the animal that seems to have made most of its limited opportunities is the domestic sheep, dosely followed horse, the pig, the cow, the dog, and all the other.",
      "These animals have made a huge progress similar to. They have escaped the pressures which would have wiped out some, in 1860, humans and domesticated animals represented percent of all plant and animal life, while about twenty percent, according to with biologists. The domestic animals, the ones that have made themselves fit in with the existerice of, are the success stories in the history of animal development",
      "This is certain to cause an argument because central claim of the animal rights movement which argues that animals should have the same right as with humans. Domestication means humans profiting from animals Humans have simply used animals for their own sellish purposes, using methods. The idea of domestication has actually helped animals survive revolutionary, and will probably make the animal rights movement even angrier. Yet, there is evidence to support it",
      "But if it was animals that took the first step in the process of domestication, agreeing to live with humans on in a voluntary basis, what exactly did they get from it? Biologists argue that the living force in all desire to ensure that they and their future generations survive, and if this is right then, wild cows and wild horses would out if domestication.",
      "in the and words or expressions"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Many places in England claim connections with King Arthur and his Knights of the Round Table and none this honour. Yet, with all high tech tools of modern archaeology, It is still impossible to know if really existed, or whather the fabulous story of men is just made-up. Similarly, many people wonder if the Round Table, around which Knights gathered, was a real round table.",
      "In fact, Arthur Round Table exists near Winchester. It was first described 1155 by the French poet Are who relied on by the guards of the mighty king. Its symbolism developed, by the 12th century it had represented the chivalric order associated with Arthur court. Today it is preserved Great Hal, which is the only part of the order Winchester Castle that.",
      "Certainly there are plenty of plenty much historical references to King Arthur. He is known to be the British leader in the early 6th century, who of Britain against Saxon invaders. Arthur had already become a folk hero by the 9 century as a warrior king. But none is very reliable. What that the idea of honor associated with him was not so popular in that period of British history, known as for the Dark Ages The significance of was that no one person, not even the mighty King Arthur, would be able to sit at the head of such a table. As Since its name suggests, it has no head, implying that everyone who sit there has equal status. A round table symbolized the concept of equality. The legend states that King Arthur order it to be built so that would resolve a conflict among his knights with regard to excess of superiority. The Round Table was therefore built to ensure that of the Round Table were equal. natural beauty/the peace/local traditions A) preserve B) exist"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Bollywood and Hollywood are two internationally moognized film industries. Hollywood is basically the entire American film industry distributing. It's named after a district in California which of movie studios in the early 1900s. It was established established before WWI and is considered to be the world's leading and influential film industry. Both stars are recognized by many people around the world. Hollywood movies are made on for a large scale. They usually involve elements of blood, violence, and other. In terms of In the course of terms of revenue. Hollywood dominates the sales. The industry earns more money by systent apart from the actual film. The movie is often ted with various other media such as and magazines. In terms of worldwide cinema, Hollywood gets around 75 per cent of all.",
      "On the other hand, Bollywood is one part of the Hindi cinema industry. The term Bollywood was coined and popularized during the 1970s, when Hindi cinema surpassed Hollywood. The name is a combination of. Movies created often family-oriented and appeal to. The dominant themes in these movies are musicals with large casts and several song and dance sequences. A major criticism of Bollywood movies is that they have a predictable and consistent plot. In addition However addition, plots lack creativity and a form of escapist entertainment. Another criticism is that Bollywood replicates plots from Hollywood movies. Just as, Bollywood also produces and distribules its films internationally but does not get the same attention as with Hollywood. The Bollywood industry produces more films than Hollywood but spends less on in production. A Movies success or eamings is reliant on and music videos that the movie produces.",
      "Choose the correct aption in the bold words or expressions."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Scuba diving is a type of underwater diving. Divers use a self-contained underwater breathing apparatus called scutie Since designed to see and breathe underwater, scuba diving requines some vital equipment. Scuba divers breathe with the help of a regulator. There is another an octopus. It is used in case of in case in terms of emergency situations. Divers also ear a pressure cause showing how much air is left in the air and Becoming requires taking a series of lessons. New divers need to could learn about the safety of diving. Moreover, they must practise diving skills first in a closed water area.",
      "Scuba diving first became the development of the Aqualung by Jacques Cousteau in the early 1940s. Articles in popular magazines about Cousteau and his underwater exploration methods brought attention to with scuba diving. Owing to Owing Since the high cost of the equipment, diving couldn't can't) couldn't become a widely available sport until years later.",
      "There are many safety issues to consider when diving For example, when down deeper in the water, a diver must be careful to equalize the pressure in his years This is done by For holding the cost and blowing very gently. Otherwise, the extreme pressure can cause damage to the middle ear and sinuses. Decompression sickness is a major concem for divers. The deeper a diver goes, the more pressure the water puts on the air inside his lungs. And, the deeper a dive, the more nitrogen gas goes into the diver's blood. For safety reasons, a diver must measure the length of his dive based on its depth so as not to exceed of nitrogen absorption When divers rise to the surface, they must carry on breathing and rise no air bubbles around them. For very deep diver they must stop and decompress at from certain levels. Therefore, the high pressurized air in the diver's lungs has time to leave the body before expands information on some precautions to be taken when diving deep"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Recent research has revealed that all common ancestor. Some scientists studied 504 modern languages, from Chinese, and discovered that every has stemmed from a dialect people spoke in Africa in prehistoric times, According to, they began to speak for the first time approximately 100.000 years ago and this was the first language in the world. However, it is not spoken any more. Early humans then left Africa, moving across Europe, Asa, and America, taking them which then altered along.",
      "Most the first humans came from Africa, but developed at different times in different parts of the world and there is no connection between them. Thus, this research is important as it suggests this is not the case. It suggests that all languages must originate from place-somewhere in Africa. The scientists made this discovery by looking at how many there were in various languages across. They discovered that the number of sounds that languages had was different in different continents. Then, they compared them with the ones in Africa, and found output off that if a spoken language was a long way from Africa, it didn't have many sounds. However, il a language was close to Africa, it had a lot of sounds. For example, Haciza, which is spoken in Tanzania, has 69 sounds, English has about 45 sounds, and Mandarin Chinese has 32 sounds.",
      "So it seems that thousands of years ago, as moving further away from Africa, they used fewer sounds in their languages. So it seems the first language was African\\! Interestingly, some African languages have a large number of a great deal of sounds. For instance, Xu, a South African language, has 141 different sounds. While are far away from Africa have many sounds, Bandjalang, an Australian language, has merely sixteen sounds."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Vocabulary & Contrast",
    paragraphs: [
      "An overwhelming majority of the people who appear most often and most gloriously in the history books ere great conquerors and soldiers, whereas really helped civilization develop are almost never mentioned at all, we do not know who first treated a broken leg, or calculated the length of a year, or grew crops: however addition, wo do know al about the killed and destroyers. They could, but we must note that they are definitely not the most civilized ones. It is true that part of the nature of all living things, but can we say the same for war-fighting? Animals fight, so such do savages, hence, to be good at be good in the way in which an animal or a savage is good, but it is not to be civilized. People fight to settle quarrels. Fighting means killing, and civilized people ought to be able to find some way of settling their disputes other than saying which side can kill off the greater number of the other, and then saying that the side which has killed most has won.",
      "On In the whole, that is what the story of mankind has been ike. But we must not expect loo much. After all, the race of men has only just started. From the point of view of evolution, human beings are just babies of a For months old. Suppose that whole past of living creatures on in Earth as one hundred years; then the whole past of man works out to about one month, and during have been Civilization for between seven and eight hours. Taking mari's civilized past at about seven or eight hours, we may his future, that is to say, the whole period between now and when the sun grows too life any longer on the earth, at about one hundred thousand years Thus at the outset of its civilized life..."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "current day writers and professors, the debate about happiness continues. What makes someone feel to feel | feel happy? The Greek philasapher Aristotle once said that a person's happiness stems from the use of intelligence. Such religious books as the Bible discuss with as a form of happiness, The British scientist Charles Darwin believed that all species were formed Way so as to enjoy happiness. People throughout history may have had ideas about happiness. Today, however, many people are still searching for its meaning.",
      "But how do you study something like happiness? You could start with the World Database of Happiness. This set of information includes how measure happiness. Some surprising. For example surprising. For example, the database suggests that married people are happier than single ones, People who like to be with other than unsocial people. Yet less expected: people with children are equally as happy as. And wealthier people are only a little poorer people. Moreover, people living and affluent countries are happier than those who do not. This database also shows that studying happiness no theories and ideas. Economists, psychiatrists, and doctors are finding ways of understanding happiness by of information.",
      "There is also an increasing amount of medical research on of happiness. Doctors can now look at happiness in a person's brain utilizing MRI. For example, an MRI can area of a person's brain is stimulated when he or she is shown. A different different area of the brain becomes active when the person sees subjects. This research may lead to better insight into mental problems."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "The sinking of the Titanic on its maiden voyage has fascinated the world for more than hundred years. It has been a EGiItTim@®@ matter of many research studies, books, films and sa on. Regardless of product, millions of people have but into years as they are all about a different aspect of the appalling axin disaster. It is a story surrounded speculation. Here are some possible scenarios.",
      "The regulations controlling lifeboats that a ship should carry were inadequate in addition to obsolete regulations. In line with these regulations, the Titanic only had to have 16 lifeboats. Nobody would have died on April 14th,1912, if had enough lifeboats for all the passengers.",
      "Small ship called the Californian was only 20 kilometres away from the Titanic at the time of the disaster. It had to stop for the night owing to icebergs. It was so near that could see each other's night The radio uGttim @ operator had gone away from the radio and thus I since he didn't hear the distress call. Later sailors saw the Titanic distress flares in the sky and woke up the captain but he didn't do anything as it was something important. If the Californian had realized the Titanic was sinking, it would have rescued. The captain of the Californian was later blamed for help the Titanic and his reputation was destroyed.",
      "ww kind Cor wan ikindi com warnings of icebergs from other ships in the area, the Titanic was going speed. The captain of the Titanic, like was under great commercial pressure to make the Atlantic crossing as quickly as possible."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "The Eskimo people have a very interesting Ife style. They live in small and under a leader respected for his ability to provide for the group. Only the most personal property is considered private and collaboration is very important. For example, any equipment that using must go to a neighbour who needs it. In the past, the division of labour between the sexes was strict. Men hunted, whereas of the homes. However, Ioday women take part in hunting as /too as much as men. Eskimo make use of various types of houses. Among some Eskimo groups, the know hut, known as for the igloo, is used as a winter residence.",
      "As for habits, Eskimo eat a wide variety of food. They consume fish, sea whales, and other sea marnmals. Eat fat and fish make up make take off a large part of their diet. Vegetables are rarely consumed because. They don't waste any food as they depend on fishing and hunting. They sometimes eat berries, roots, stems and some other.",
      "Their education takes place within the family and the community circle. By constant exposure to food their parents and other adults in the community. children leam all they need to live successful The Eskimo of old did not have a written language, so skills and knowledge were passed down of mouth. After a successful just for example, the details were shared with the community. The children, boys in particular, listened to describe in detail the location where animal and tell about the animal's behaviour. Besides hunters' stories, the children would observe the behaviours of animals. As opposed to noisy children of modern society, being silent is something Eskimo children are taught as it is a necessity for hunting. Moreover contrast. they leam to memorize the landscape and thus know the region just like an adult 1.rules/regulations/orders A) strict to sunlight/radiation/criticism/language A) exposure B) involvement",
      "1. property (n) in the food words or expressions."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "So many of us strive so hard for material success that you might think there is a clear relationship between wealth and happiness. The media and our governments encourage us to believe this since eéttim® although / since they need us to keep earning and spending to boost economic growth. vit",
      "Consequently, it comes as a shown for many people to learn that straightforward @ ain relationship between wealth and well-being. Once our basic material needs are satisfied (i.e. regular food, adequate shelter, and financial security), wealth only has a negligible effect on well-being. For example, studies have shown that in general, lottery winners do not become significantly happier than they were before, and that even extremely rich people — such as billionaires — are not significantly happier than others. Studies have shown that American and British people are less content now than they were 50 years ago, although is much higher. On an international level, there does appear to be some correlation between wealth and well-being, partly because there are many countries in the world where people basic material needs are not satisfied. But this correlation is not a straightforward one, since wealthier countries tend to be more politically stable, peaceful and democratic, with less e¢itin@ oppression and more freedom — all of which factors in well- vin vit being.",
      "However, it does appear that there is a relationship an between non-materialism and well-being, While material goods doesn't lead to happiness, giving these things away actually does. Generosity is strongly associated with well-being. For example, recent studies of people who practise volunteering have shown have better psychological and",
      "mental health and increased life spend The benefits of volunteering have been found to be greater than taking up exercise or attending religious services — in fact, even greater than giving up smoking.",
      "So if you really want to enhance your well-being — and as long as needs are satisfied — don't try to accumulate money in your bank account, and don't treat yourself to material goods you don't really need. Be more generous and altruistic; increase the amount of money you give to people in need, give more of your time to volunteering, or spend more time helping other people, or behaving more kindly to everyone no one everyone around you."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Most Hollywood movies on Artificial Intelligence (Al) portray a terrifying future in which machines become so clever that even destroy us. And influential figures in this field such as eéttim@® rather than / such as Stephen Hawking and Elon Musk have called for caution. So, does this make the vit conquest by computers inevitable? With such a created subject, it's worth trying to distinguish what's plausible from what's too far-fetched to worry. For a start, we live with Al already. The calculations behind your Google searches or your browsing on Amazon are not just running in the background — the software is constantly learning how rapidly and usefully,",
      "This is remarkable, but it is described as \"narrow\" or we Al because work within the guidelines created by its human inventors crucial limitation. By contrast, \"general\" or — a crucial limitation. By contrast, \"general\" or \"strong\" Al which 6 / which does not exist yet implies a more assertive ability to do things that go beyond the original human intentions, not just to \"think\" but also to improvise. Huge obstacles stand in the way of getting there, like mimicking how a human brain works. For a reality check, we visited NASA engineers working the most capable robots in the world. People working there laughed at the notion of laughed at the notion of a robot army someday taking a robot army someday taking over - \"lam not concerned about intelligent machines,\" said project leader Brett Kennedy. He Eğirim @ said: \"For the foreseeable future, | am not concerned, as a human. | have first-hand knowledge of how hard it İs for us to make a robot that does much of anything. \"To anyone worried about Al, this would be reassuring.",
      "But predicting the future have of technology is impossible. The key and most momentous milestone — human-machine equality — is called Artificial General Intelligence, and academics are trying to assess when that might arrive and what. One is Prof Nick Bostrom, who, in his recent book, suggests that there's a 50% chance that",
      "computers could as soon as 2050. The same study says there's a 90% chance of machine-human equality by of Al — because it could help tackle climate change, energy and new medicines — but he also brings up a compelling make of mankind behaving like a curious child wha has picked up an unexploded bomb, without. \"Maybe it is decades away, but we are just as immature and have as this child. We really don't realise the power of this thing we are creating.\"",
      "Prof Bostrom is now receiving funding from Elon Musk to explore these issues, and the aim is to is to develop a shared approach to safety. We could imagine a scenario where unstoppable but the scariest scenarios —of robot destroyers — are somehow evaded because the right steps are taken. But then another quieter, less obvious form of takeover may still be possible. In his latest book, Prof Worry Kaplan states that \"As we learn to trust these systems to transport us, introduce us to potential mates, customise our news, protect our potential mates, customise our news, protect our property, monitor our environment, care for our children and elderly, grow, prepare and see our food, it will be easy to Most the bigger picture.\" Ultimately, there are risks, no don't The question is the text. Which of the following is FALSE, according to paragraph 17 Prominent people in the Al field are against the dangers of artificial intelligence."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Why Does the Heart Want What It Wants? Why Does Heart Want What Wants? “The heart wants what Emily Dickinson wrote that. But why? medical romantics believe? believe? Is it inexplicable? This theme is evident inexplicable? This theme evident beyond beyond these pop culture references. But this is these pop culture references. But this psychology, Psychology, and we seek to know the \"why\" beneath and seek know the “why” beneath the the surface explanation. Most people would like to surface explanation. Most people would like attribute attribute attraction to some mystical force Yet in attraction some mystical force Yet in eeitrin@ eölrim( which which/ that brings people together. But there are that brings people together. But there are some some scientific explanations. scientific explanations. bib There There are deeper, more psychoanalytic aspects are deeper, more psychoanalytic aspects attraction. In the excellent book, A General Theory of Love, the authors discuss whenever in our childhood leads to attraction to others later in life. Basically, we form strong memories from our early childhood experiences. These unconscious memories guide our attraction to has, We may not understand why we are attracted to someone, but we how. This theory explains how people find themselves attracted to Someone who proves to be unhealthy for them.",
      "The next aspect of attraction I'd like to discuss is the psychoanalytic idea of projection. A projection is an internal ideal, thought process, or state that is attributed to another person. whether, the individual has an idea, unconsciously, of how they want and need their ideal mate to be, and they place these attributes and qualities into another individual. They then observe their potential Partner's behaviour, and relate it to their ideal. If they do not realise that they are projecting, they then believe they have found their soul mate. that, as they come to know the person better, the partner begins to fall short of their expectations ~ falling short of expectations so consistently Even if / he decide the other cannot be the ideal, and often the search for the real soul mate begins again. This pattern of disappointment will continue that realises the reality of projection, and does not give in to the fantasy that they have found their soul mate. Earlier, the subtle ways that opposites attract such as. For this, there isa psychological theory called compensation. In compensation, one overdoes an aspect where they feel insecure. to want, they might buy big trucks when they do not feel very money Compensation in regard to attraction Is similar, those relates more to the choice in a pariner than a weakness. Care Just identified",
      "personality traits that people tend to favour: introvert or extrovert, feeling or thinking and intuition or sensing. İt is often contended that people tend to choose a partner As into balance. For example, outgoing, social people often pair with quieter, more reserved types. This may often be a function of compensation, instead of that which has contributed to the attraction and emotional attachment. Another aspect of relationships would ignore is the bargaining process that many go through unconsciously. This is not an external, what. Each EĞitTiM person entering a relationship is aware of the attributes that they bring to the table. These can include attractiveness, financial security, a quality of sweetness, intelligence, being a giving person, Sweetness, intelligence, being a giving person, being attentive, considerate, and so on. (16) Known! Knowing what attributes one brings to the table, the individual wants a comparable partner. This does not mean that one necessarily wants someone exactly (17) more / as attractive, nice, financially secure, and so on as he is, but it means that he wants an equal or slightly better bargain in line with what he values, (18) Even so / Otherwise, this person might just end up getting dumped."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Vocabulary & Cause-Effect",
    paragraphs: [
      "\"The heart wants what it wants. Emily Dickinson wrote that. But why? Is it as magical as romantics believe? is it inexplicable? This theme is evident beyond these pop culture references. But this is psychology, and we seek to know the \"why\" beneath the surface explanation. Most people would like to attribute attraction to some mystical force that. But there are some scientific explanations.",
      "There are deeper, more psychoanalytic aspects of attraction. In the excellent book, A General Theory of Love, the authors discuss how our childhood leads to attraction to others later in life. Basically, we fann strong memories from sur sarly childhood experiences. These unconscious memories quide our attraction to others. We may not understand why we are attracted to someone, but we nonetheless. This theory explains how people find themselves attracted to someone who proves to be unhealthy for them.",
      "The next aspect of attraction I'd like to discuss is the psychoanalytic idea of projection. A projection is an intemal ideal, thought process, or state that is attributed to another person, in other words, the individual has an idea, unconsciously, of how they want and need their ideal male to be, and they place these attributes and qualities into another Individual. They then observe their potential partner's behaviour, and relate it to their ideal. If they do not realise that they are projecting, they then believe they have found their soul mate. however, as they come to know the person better, the partner begins to fall short of their expectations-falling short of expectations so consistently that other cannot be the ideal, and often the search for the real soul mate begins again. This pattern of disappointment will continue until realises the reality of projection, and does not give in to the fantasy that they have found their soul mate Earlier, the subtle ways that opposites attract was mentioned. For this, there is a psychological theory called compensation. In compensation, one overdoes an aspect where they feel insecure. For example, they might buy big trucks when they do not feel very manly. Compensation in regard to attraction is similar, although relates more to the choice in a partner than a weakness. Carl Jung identified personality traits that people tend to favour: introvert or extrovert, feeling or thinking and intuition or sensing. It is often contended that people tend to choose a partner that into balance. For example, outgoing, social people often pair with quieter, more reserved types. This may often be a function of compensation, which the attraction and emotional attachment.",
      "Another aspect of relationships that ignore is the bargaining process that many go through unconsciously. This is not an external, but. Each person entering a relationship is aware of the attributes that they bring to the table. These can include attractiveness, financial security, a quality of sweetness, intelligence, being a giving person, being attentive, considerate, and so on. Knowing brings to the table, the individual wants a comparable partner. This does not mean that one necessarily wants someone exactly as, nice, financially secure, and so on as he is, but it means that he wants an equal or slightly better bargain in line with what he values. Otherwise, this person might just end up getting dumped 1.feeling/desire/need"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Elysium Health, a drug company, hasn't discovered the fountain of you but could change how you get older. Say someone came up to you selling a dietary supplement a pill that you take once a day-that could boost your energy, improve your body's ability to repair its DNA, and keep you healthier as its you get older. It might a Say or more likely just another in a sea of confusing, undifferentiated claims that which make up the $20-billion-dollar supplement industry. But let's say that someone is Massachusetts Institute Technology or Its Lenny Guarente, one of the world's leading scientists in the field of aging research. And he's being advised by Five Nobel Prize winners and two dozen other top researchers in their fields. You might pay a little more attention",
      "Co-founding a supplement company seems an likely career move for someone like Guarente, a man who the most well- respected scientists in his field. Mostly, for him, his getting involved in Elysium Health is a decision bom out of opportunity and frustration. The opportunity is the chance to make a difference by the becoming field of aging research directly to consumers today. The frustration is that taken so long in the first place. \"My biggest hope is that we can make something that to people available, and that it will hava a positive impact once their health, Guarente says",
      "Elysium Health actually had its beginnings in conversations between its other two, longer co- founders, Enc Marcotulli and Dan Alminana, who were then tech investors and gym buddies. They're both, and they knew they couldn't halt the march of aging and all the ailments that. Far more than diet or anything else people can control, the biggest risk factor for many of the diseases that kill including diabetes, cancer, and cardiovascular disease is simply getting older, And there is nothing to stop to be stopped stop it. If anything, Elysium might make more people aware that aging is becoming something that we may one day treat employmnt for the promising young scientists D) Elysium Health will outperform the rivals in the industry by recruiting eminent scientists 1. confidence/morale/sales / production A) boost"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Past Simple & Vocabulary",
    paragraphs: [
      "Isaac Newton most to become the most influential scientist of the with century, with his ideas becoming the foundation of modern physics, after very humble beginnings However, did an apple really fall on Newton's head and Sir him on to figure out gravity? Historians say there is likely not even a small amount of truth to the story.",
      "Sir Isaac Newton was born, premature and tiny, in 1842 in England. It's said that he didn’t excel, bul he ended up studying law at Trinity College Carribridge, part of Cambridge University. Meanwhile, he worked as a servant to pay his will and kept a joumal about his ideas, but what got Newton interested in math? He bought a book on the subject and couldn’t didn't have couldn't even comprehend it. Yet, after getting his bachelor's degree in 1665; he studied math, physics optics and astronomy on his own (due to Cambridge's being closed for a couple of years due to the plague known as the Black Death). By 1666, ha had completed work on his three laws of motion, Later he got his master's degree. His lowe are still used by physics students today. For example, an subject will rerrain in a state of inactivity unless i unless moved by a force, or for every action, there is an equal and opposite reaction.",
      "While known for his work on gravity, Newton was an inventor, too, but more with ideas than physical inventons. He did invent reflecting lenses for telescopes, which in a smaller telescope compared to the refracting models of the time in his later years, he developed anti- counterfeiting measures for coins, including see on quarters today. Among his biggest \"nventions\" was calculus, Yes, that's right. Very math and algebra weren't enough to explain ideas in his head, so he helped invent calculus, German mathematician Gottfried Leibniz is typically credited with developing it independently at about the same him It's also said that Newton invented a cat or so that get in, but the truth of that one is a bit sketchy. There is no actual evidence that he really did invent it",
      "Urged Halley (who was studying his now-famous comet), Newton continued to study his notion of gravity and apple it to the motions of the Earth, Sun and Most It all led to his seminal work, published 1687, called the Principia - considered by many as the greatest science book ever written Newton's research stopped in 1679 when nervous breakdown. Later, after he recovered, he spoke out against King James II, who wanted only Roman Catholics to be in powerful governmental and academic positions. When King James II was later driven out of England, Newton was elected to Parliament. He had a second breakdown in 1693, and then retired from research. Isaac Newton died in 1727",
      "According to paragraph 4, Principia- A) may be the greatest science book ever written: however, at the time it wasn't appreciated enough B) was considered as something against Roman Catholics by King James II and Newton got punished 1. a/n considerable/large/enormous A) gravity"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Relative Clauses & Vocabulary",
    paragraphs: [
      "During the Cold War, Americans were digging holes. Lots of holes. Holes that bottled water and non-perishable food and tons and tons of concrete shelters where if Soviet bombers dropped over the country. In 1961, President Kennedy pressed Americans to protect EĞlTiM themselves from nuclear fallout by building bomb shelters. The shelters were supposed to inhabitants from blast pressure. The reality was those shelters wouldn't do a thing to protect people from full-scale nuclear attack.",
      "Most people are familiar with fallout shelter signs left on buildings from the Cold War era. They were put in place by the Office of Civil Defense, which President Harry Truman to educate people about how to protect instance of a nuclear attack. Scientists knew, however, that released deadly gamma rays, which with enough concrete and distance underground. Radiation can literally how over very quickly, depending on the size of the blast, so, or even the whole affected city, wouldn't burn forever. But again, that was only if you weren't directly hit by the blast.",
      "The fallout shelter was one of the thickest safety blankets ever wrapped around the collective shoulders of terrified citizens. American culture embraced these ineffective methods, believing — or even a school desk — would be enough to survive full-scale nuclear attack, Typically, the shelters were “draconian — dark, and and dangerous,\" said Had Walls director of the Institute for Disaster Management at the University of Georgia, in a phone vit interview, In movies like Blast from the Past, however, the bunker was romanticized as a sophisticated underground oasis, stocked with power, food, water and activities.",
      "“| think the shelter systems, public and private, were all part of a great defeat in a way,\" said Irwin Redlener, Clinical Professor of Health Policy. We thought that a nuclear war would be survivable. But it just wasn't. It was just not going to be possible.\" One theory about the origin of the fallout shelter is that the U.S. wanted",
      "it to look like it was too expensive to destroy. Evacuation plans were meant to send a message to the other side that they'd survive. However, if Soviet Union had ever called this bluff, its nuclear payload would have killed millions.",
      "Nuclear blast create shockwaves and high-speed wind that the walls off a house. Then comes the radiation. Some radiation, alpha particles, can't penetrate your skin. But another form, called gamma rays, are deadly and strong enough to radiate lot of mediums, but not necessarily think concrete. If a single Tsar Bomb, a 50 megaton thermonuclear bomb, fell on New York City, over 10 million people power of both sides of the war were EXERCISE nothing would survive. The surface would be radioactive for who knows how long. In 1961, the Soviet Union detonated the Tsar Bomb which had an expensive force of 50 million tons of TNT. By comparison, the bomb that hit Nagasaki, the \"Fat Man,\" had a force of only around 20,000 tons. To understand the extent of the Tsar's devastating power, consider what 500 times water did, Those nukes are still around. Today, the U.S. has a stockpile of around 7,100 nuclear weapons. Russia has around 7,700, Take cover CONSE: the text. Which of the following is TRUE, according to paragraph 1 and 27 The holes the Americans dug helped them protect themselves from the nuclear attacks a on act lm IS BOF: Malik della President Kennedy knew that the only solution to President Kennedy knew that the only solution to survive a nuclear attack was to build bomb shelters. Harry Truman wanted American citizens to be more informed about nuclear attacks. People would have been protect from deadly gamma rays in the 60s due the depth of the shelters.",
      "According to paragraph 3, is the following According to paragraph 3, is the following statement TRUE or FALSE? \"Shelters were depicted true to their originals in the movies like Blast from the Past”."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Past Simple & Vocabulary",
    paragraphs: [
      "It may come as a surprise to current Milton Hershey faris, but success came with the manufacture of caramel. After his Philadelphia store. Milton headed for Denver, where he learned the art of making caramels. There, he took a job with a local manufacturer who insisted on using fresh milk in making his caramels: Milton saw that caramels especially tasty. After a time in Denver, Milton once again attempted to open his own candy-making businesses, in Chicago, New Orleans, and New York City. Finally, in 1886, he went to Lancaster, Pennsylvania, where the money necessary to try again. In 1887, Hershey established the Lancaster Caramel Company, which outstanding success. Utilizing a caramel recipe which he had obtained during his previous travels, his company soared to the top. It was this business that a candy maker, and set the stage for future accomplishments. In 1893, Milton attended the Chicago International Exposition, where display of German chocolate-making implements. The equipment was captivating. He immediately purchased it for his Lancaster candy factory and began producing chocolate, which he used for coating his caramels. By the next year, production had grown include cocoa, sweet chocolate, and taking chocolate. The Hershey Chocolate Company was born in 1894 as a subsidiary of the Lancaster Caramel Company. Six years later, Milton sold the caramel company, however, he retained the rights and the equipment, to make chocolate. He believed that, lucrative market of chocolate consumers was waiting for someone to produce a reasonably priced candy",
      "Using the came of the Lancaster Caramel Company, Hershey initially acquired farm land roughly 30 miles northwest of Lancaster, near his birthplace of Derry Church. There, he could obtain the large supplies of fresh milk needed to perfect and produce Life milk chocolate Excited the potential of milk chocolate, which at that time was a luxury product, Hershey was determined to develop a formula for milk chocolate and market and sell it to the American public Through, he created his own formula for milk chocolate. The first Hershey Bar was produced 1900. Hershey's Kisses were developed in 1907, and the Hershey Bar with almonds was introduced in 1908. On March 2, 1903, he began constructing what the world's largest chocolate manufacturing company, only he didn't know that it would success. The facility, completed in 1905, was designed to manufacture chocolate using the latest Man production techniques. Hershey's Milk Chocolate quickly became the first nationally market product of its kind.",
      "The area where located is now known as Hershey, Pennsylvania. Within the first decades of its existence, the town of Hershey thrived. as words did the chocolate business. A bank, a school, churches, a department store, even a park and a trolley system all appeared in short order; the town soon even had a zoo. Today, a visit to the area reveals the Hershey Medical Denver the Milton Hershey School, and Hershey's Chocolate World, Ø visitors are greeted by a giant Peanut Butter Cup. All of these things and a huge number of happy chocolate lovers- were made possible because, decisive caramel maker visited the Chicago Exposition of 18931 1. heart/kidney/market/power... A) failure B) theme"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Located in the South Pacific between Chile and Tahiti, Easter Island is one of the most isolated inhabited islands in the world. The first islanders found a green island, filled with giant palms which build boats and housing. The plants they brought with them did well in the rich volcanic soil and eGtrim@® by AD 1550 population on a high of between 7000 and 9000. Here, in isolation some vit 2,300 miles west of South America and 1,100 miles from the nearest neighbouring island, the first islanders developed a distinct architectural and artistic islanders developed distinct architectural and artistic culture.",
      "For reasons still unknown, they began carving giant statues out of volcanic rock. These monuments, known some of the most incredible ancient relics ever discovered. The people of Easter Island called themselves the Rapa Nui, Where did they come from and why did they disappear? Science has learned much about the enigma of Easter Island and has put to rest some of the more bizarre theories, though remain.",
      "Darwin pointed out how groups of animals living in remote places eventually take on unique characteristics and eventually turn into distinct species. Such is the case with the people of Easter Island. Unique as a culture, the Rapa Nui left clues as to in their language, art, and beliefs. Contemporary archaeologists think it's an öpen and South case: the first and only people ever to live Island were from an individual group of Polynesians. Upon, they had no contact with any other places until after until of course, that fateful day in 1722 when, on Easter Sunday, Dutch commander Jacob Roggeveen, became the first European to \"discover\" the island. What and recorded once on the island has fuelled origins of the Rapa Nui ever since.",
      "The Rapa Nui's mysterious moai statues stand in silence but speak volumes about the achievements of their creators. The stone blocks, carved, average 13 feet (4 meters) tall and 14 tons. The effort to construct these monuments and move them around the island must have been but no one",
      "knows exactly why the Rapa Nui people undertook such an incredible task, Most scholars subject that created to honour ancestors, chiefs, or other important personages. However Thus However, no written and little oral history exists on the island, so it's impossible to be certain, This culture reached its zenith during the 10\" to with centuries, when carved and created some 900 moai across the island.",
      "It is generally thought that the Rapa Nui's collapse resulted from an environmental catastrophe of their own making. It’s not clear when first settled; estimates range from A.D. 800 to island ecosystem was wrecked — but a major factor appears to be the cutting of millions of giant palms to clear fields or make fires. It is possible that, arriving with human settlers, may have eaten seeds to help to destroy the trees. Ejther way, loss of the trees exposed the island's rich volcanic soils to serious erosion. When 1722, they found the island mostly infertile and its inhabitants few.",
      "Today's tourists are numerous, and most visit the And Raraku quarry, which used for almost all of the island's moai, The Rapa Nui's ancient inhabitants left the quarry in a fascinating condition — it is home to some 400 statues, which appear in all stages of completion. Meanwhile, across the entire island, many moai are reversing the creation process and deteriorating rapidly from priceless Carvings back into plain rock. The volcanic stone is subject to weathering. Therefore However Therefore, intensive conservation efforts are needed to help preserve the Rapa Nui stone legacy in its present state."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Past Simple & Vocabulary",
    paragraphs: [
      "Benjamin Franklin was born on January 17, 1706 in Boston, Massachusetts. He was one of ten children bom to Josiah Franklin, a soon maker, and his wife Abiah Folger. Josiah wanted Benjamin to enter but could not afford to send him for schooling. Consequently, when Benjamin was twelve, he helped his brother James who was a printer and taught Benjamin about the job. Benjamin worked extremely hard at formatting the text and composing publications. When Benjamin was fifteen, his brother printed the first editorial newspaper in Boston. Unlike throughout Boston that simply reprinted events, James' newspaper, called The New England Courant, printed articles and editorial columns. Benjamin was very interested in his brother's newspaper and wanted to help him writer it So. he thought of a plan. He would write under an anonymous pen-name and slip the articles under the soon at night. He chose the name Silence Dogood, Articles written became very popular. People throughout Boston wanted to know who she was. She spoke out about issues abroad and the poor treatment of womert. Finally, after 16 letters, Benjamin confessed lo James that Dogood. James was very angry and jealous of received.",
      "Nevertheless, the paper continued. James' editoriais became increasingly criticat of the Puritan leadership within Boston, especially for their support of the smallpox inoculation (which the Franklin believed made people sicker). Due to criticisms, the police put James in prison and Benjamin was left in large of publication. When James was released from jail, he Read Benjamin, even though been quite successful in the publication business. In 1723. Benjamin ran away and eventually ended up in Philadelphia, Pennsylvania, where Read While in Philadelphia, Benjamin lived with her family and soon found work as an apprentice printer. Franklin was an excellent printer and was sent of Pennsylvania to London to purchase font types and printing supplies. In exchange for service, the governor promised to help Benjamin start his own printing business. In the meantime, Benjamin and Deborah had grown very close, and she had begun to suggest they should get mamed. Benjamin left unprepared, and left for England. Unfortunately, the governor had died about helping him, and Benjamin was forced to work in London for several months. Deborah mamed another man while he was gone.",
      "Upon Philadelphia, Benjamin borrowed money and started his own printing business. He worked extremely hard and soon received contracts. Benjamin business became very successful and he became well-known throughout Philadelphia. In 1730, he married Deborah Read, whose her",
      "In the meantime, Benjamin was also carrying out science experiments. He had already invented the Franklin Stove, which keeping large houses warm in the winter, as well as glasses. He soon became interested in the concept of electricity. In 1752, Franklin devised a simple experiment to see if harnessed from a storm. He succeeded and gained international came",
      "Soon Benjamin turned to politics to satisfy his strong desire to leam. He soon became the coloriial representative for Pennsylvania Massachusetts. Georgia and New Jersey in England. He stayed in England for 18 years, enjoying a wealthy diplomat. Although wife to join him in England, she refused and eventually died while Benjamin was in England.",
      "Benjamin Franklin then came home to join the cause for independence. He was elected of the Continental Congress and helped Thomas Jefferson draft the Declaration of Independence. After he signed The Declaration of Independence, Franklin set sail for France as America's ambassador, Franklin hard and persuasion were successful in convincing the French to sign the 1778 Treaty of Alliance, which which asserted France intention to aid the colonies in their quest for independence, and secure loans for military supplies, In 1783, Franklin attended the signing of the Treaty of Paris, which ended the Revolutionary War. After returning, Franklin became a member of the Constitutional Convention and signed the Constitution in 1787. He died three years later on April 17, 1790 Twenty thousand people attended his funeral."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Are Smart Phones Manipulating Your Brain?",
      "A research paper has determined that to looking at the \"big picture\", the human brain is more capable of inferring broader ideas and themes from words printed on paper than those appearing on a digital screen. Between smartphones, work desktops, tablets and laptop sometimes the only time we are ever really away BİL from a digital screen is when a pillow. As a result of these ubiquitous glowing screens, two professors from Carnegie Mellon University and Dartmouth College set out to question whether by our digital habits. Their unnerving conclusion suggests and LCDs of this world actually cause their readers to enter a form of tunnel vision that mental ability to think ‘outside the box’,",
      "Professors Geoff Kaufman and Mary Flanagan conducted a series of tests, documented in a recent research paper. The tests compared various everyday screen-based tech — including a tablet (an iPad 2) and a laptop screen / monitor — with text printed on ordinary paper. that The pair's tests were designed possible differences in cognitive patterns between “digital and non-digital platforms.” (II) A group of 77 subjects were asked with various quizzes that involved problem solving and basic literary analysis. (IM) The ecitim results across four different tests all pointed to the same conclusion that viv likely to consider abstract ideas (or, for want of a better phrase, read between the lines) on paper. (IV)",
      "“Digital screens almost seem to create a sort of tunnel vision where moment, not the broader context,” Kaufman told The Washington Post. “On the iPad, they seemed not to focus or show consideration for the long-term effects of their decisions. And they just lost the game much more often.\" As an example, one experiment",
      "involved a surprise exam based on by author David Sedaris. A PDF and paper version was then split between who to a surprise more exam consisting 24 multiple-choice questions",
      "The questions were split to measure the participants’ “memory of specific details presented in the narrative\", but also their \"understanding of higher- level inferences that the author intended readers to mean from the story\". Kaufman and Flanagan note digital guinea big score higher on memory-based, factual questions, while subjects \"exhibited higher scores on the inference items”. Another lab test asked the participants to judge which from a specification list for two separate cars, with one being objectively superior. When faced with an “information overload\", the non- digital half again prevailed, with 66% choosing the correct car, whereas 43% of the laptop users chose the right answer.",
      "Should we abandon our screens? The researchers stress in the paper that took into account the possible differences between the two platforms by keeping the font-size and layout the same for both printed and digital text. They also point out that “lack of familiarity with mobile devices\" excuse would not be enough to affect negatively, So does this mean we should abandon our screens immediately? Kaufman seems to think this would be bit drastic, yet how his own habits could benefit those looking to avoid digital-blinkers.",
      "10850 420 (2546) (oes 420 (2546) the text, What is the main idea of paragraph 1? Since digital screens becamea Since digital screens became a part of people's part of people's lives, they almost never part with them time they go to bed. On paper, itis easier for people to put things into a larger perspective than it is on a digital screen. Nowadays, people are reading so little on paper EĞirTiM(A) eGitin® that scientists now are conducting research on this issue. vit Digital screens damage people's inference skills as much as words printed on paper do."
    ],
    vocabulary: [
