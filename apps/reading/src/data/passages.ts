...
export const PASSAGES_DATA: Passage[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "B. associate (v) © 1 What are the customs for kissing people in your country? Do you kiss your relatives when you visit them? Do you kiss your friends hello when? Is it polite to kiss someone in public places in your country? All of these kissing customs depend on where in the world you are. Kissing may seem as universal as language, but in fact, kissing customs differ around the world. 2 In many places, kisses are used hello. If you are in Europe or South \" America, you will see lots of these greeting kisses. But the kissing customs for greeting people vary from country to country, and traveling to new places can be confusing if don't know them. Many European men and women say hello with two kisses, one on each cheek. But three kisses are polite in Belgium, and young people in Paris often prefer four. In these countries, you must the right cheek. Starting with your left cheek would be as awkward as sticking out your left hand for a handshake. A variation on the cheek kiss is found in Brazil. When women meet, they put their cheeks together and kiss the air. In some, men kiss each other on the cheeks at some parts of the world, people don't kiss when they meet each other. In fact, kissing in public is considered impolite. In Japan and China, for example, people in public places rarely kiss each other. In most Middle Eastern countries, men and women do not kiss in public, Merkezi ve Yayincilik Hizmetleri 3 Kisses aren't just for saying hello; people kiss for lots of other reasons as well. For example, a kiss can also of respect. Some people show respect by kissing religious articles and flags. Others kiss the ground when they come home to a country they love. Europeans J and Latin Americans also use kisses to say - beautiful!” They kiss their fingertips when they see a pretty woman, an expensive car, or a great s soccer play. In other places, people say good-bye by kissing their fingertips and blowing the kiss away. Kisses are associated with - good luck, too. The French started the custom of kissing their cards for good luck before playing, 5 and today, some people kiss a pair of dice before they roll them. The English kissed hurt fingers to make them better, as do today. And, of course, people also kiss to make up after a fight."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "ED dea dh Ad AREER E dma eed Merkezi ve Yayincilik Hizmetleri Homeschooling y 1 Homeschooling is education at home where parents are teachers. In homeschooling, children don't go to school but study at home with ad Homeschooling appeared in the 1960s in the U.S.; A philosopher called John Rushdoony was the first person who had this idea in. He ) thought that children needed to learn about religion at school. But schools did not teach them anything regarding religion, so devise his own education system and teach his kids at home. The idea suddenly became so and more parents stopped sending their children to school and taught their children at home. Today, home schooling is most popular in Canada, France and the US. Many families in these countries don't to schools and they play an active role in their children’s education. Currently, there are over one million families that school their children at 3 Homeschooling is popular and there are three reasons for it. The first reason is about ’ teachers at schools. People homeschool because they are not happy with the education in schools. y They think teachers are not good enough. There are also economic reasons: Some don’t have enough money for private or even public schools. And the last reason is about safety. Some think schools are not safe places for their children. They think school environment and friends may be dangerous for www.okindil. com 4 How can parents teach their children when teacher or a standard program? Home school families use technology to find teaching materials. Many parents use the internet or computer programs to teach standard subjects like math, reading, history, science and grammar. Most of them create their own lesson plans. They regularly meet with other home schooling parents © and share their ideas. They help each other good lessons-to make their lesson plans better. 3 o> There are negative opinions about homeschooling. z For some people, it is a terrible idea. They don't like - it because they think homeschooled children can’t GS) socialize, interact with other people easily, and they become unsociable. They also think that parents are not professional teachers. They can't teach their children math, science and literature well. We have to is not true. Exam scores show that homeschool children are more successful-they perform better than public school children in standard exams. religion at home ® children ----, ). economic / educational / environmental ---- ). =-== place / neighbourhood / distance"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Merkezi ve Yayincihik Hizmetleri 1 Tattoos are in fashion in many countries. On TV you ) can actor with a picture on her arm, or your favourite musician with a word on his hand. Many got them on their necks and backs. The most popular designs are Japanese and Chinese characters and the names of people who we love. i Women often prefer smaller designs like stars, flowers and men are interested in much bigger 3) images. In the USA, tattoos are very popular. 40% of Americans between the age of 26 and 40 have got a tattoo and 60% of customers in US tattoo shops are women. These people are often professional people now tattoos are popular with all kinds of people and it's normal to have a tattoo these days. 2 However, tattoos are not modern. In fact, they are very old in human history. For example, archaeologists found a human in ice from 5000 years ago. He had 57 tattoos on his back, ankles, legs, knees and feet. They were used for many different reasons. In ancient Egypt, people put on tattoos because 3 because / but they were ‘beautiful’. But in ancient Rome, tattoos were negative and put on criminals and prisoners. In India, tattoos were religious.: In The 16™ and 17\" century, European sailors arrived in the islands of Polynesia. They saw tattoos for the first time. The people on the islands had tattoos on their shoulders, chest, backs and legs. Often the ) tattoos were designs of features like a river or a mountain. The European sailors liked them and tattoos. And so the idea travelled to Europe. Tattoos in Polynesia are still important today. They give information about, their island or their job. 4 So is there a connection between traditional tattoos and fashionable tattoos? And can you call tattoos a fashion? Chris Rainier of National Geographic is an expert in tattoos. So, he studies the tattoos in detail but he designs tattoos, too. His book Ancient Marks has photos of tattoos from all over the world. Those photos were taken by his friend David Knight — a world famous photographer. He thinks © people in modern societies often have tattoos pe because they are a connection with © traditional world. x have tattoos of ----. paragraph 3? animals in Polynesia. XERCISE 4. do something ---- the first time. ---- to Asia / by train / light difference / trade / connection ---- two countries. ---- dress / ring / idea"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "————————————————————————— Merkezi ve Yayincilik Hizmetleri A Boat Made of Bottles 3 1 The Plastiki looks like other boats or yachts in Sydney harbour. It's 18 m long, 6 m wide and it - weighs about 12000 kg. It carries a crew of 6 people - and has an average speed of 5 knots. However, when to the Plastiki, you realise there's a difference. It's made of 12500 z recycled plastic bottles. ) 2 One day, the environmentalist David De Rothschild was reading some information about in the seas and oceans. He couldn't believe what he was reading. For example, humans throw away four out of every five plastic bottles that they use and plastic rubbish causes about eighty per cent of the pollution in the sea. Soon afterwards, Rothschild decided that he wanted to help the fight against pollution in the sea. To create publicity for the problem, he started building a boat made of plastic bottles so that everyone would about it. 3 As well as building the boat with recycled plastic, it ) was important for the boat environmentally-friendly. It uses wind power and solar energy. The crew make meals with garden at the back of the boat. They can do exercise by using the special exercise bicycle. The energy from the bike provides power for the computers. And if take a shower, the boat's shower uses saltwater ) from the sea. 4 De Rothschild sailed the Plastiki across the Pacific Ocean from San Francisco to Sydney. That's 15372 nautical kilometres. On the way, De Rothschild took the special boat through the ‘Great Garbage Patch’. It is a huge area in the Pacific with 3.5 billion wane ak indi! foe kilogrammes of rubbish. You can see every rubbish here: shoes, toys, bags, toothbrushes, but the worst problem is the plastic. It kills birds and sea life. 5 The journey wasn't always easy and De Rothschild and his crew had to during © storms. There were giant ocean waves and winds of took 129 days. Originally, De Rothschild thought the boat could only travel once but 5 survived so well that he is planning to sail it again a rubbish in the Pacific Francisco and Sydney"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Merkezi ve Yayincilik Hizmetleri 1 Did you know that animals are also each other? Bees communicate by dancing. Whales talk to each other by singing. And some apes talk to humans by using American Sign 2 Meet Koko: a female gorilla born at the San Francisco Zoo on July 4th, 1971. Koko learned sign language from, Dr. Penny Patterson. Patterson began teaching sign language to Koko in 1972, when Koko was one year old. Koko was a good student for sure, so she moved onto the Stanford University campus with Dr. Patterson. Koko continued to learn on the campus until 1976. That's when full-time with Patterson's group, the Gorilla Foundation. The relationship between Patterson and Koko has blossomed ever since. 3 Dr. Patterson says that Koko has mastered sign language. She says that Koko knows over 1,000 words, and that Koko makes up new words. For example, Koko didn't know the sign for ring, so she signed the words finger and bracelet. Dr. Patterson thinks that this shows meaningful and constructive use of language. 4 Not everyone agrees with. Patterson. Some argue that apes like Koko do not understand the meaning of what they are doing. Skeptics say that these apes are just performing complex tricks. For example, if an apple and signs red or apple, Dr. Patterson will give her an apple. They argue that Koko does not really know what means. She only knows that if she makes the right motion, then apple. The debate is unsolved, but for certain: Koko is an extraordinary ape. drainer Adtesadi? Soa @ossoszoacn sss):XERCISE 4.. ---- a language / the results. ---- a plan / relationship"
    ],
    vocabulary: [
    ...
    questions: [
      {
        id: 1,
        question: "the text. 1. In paragraph 1, the author mentions different animals to show that ----.",
        options: [
      ...
      },
      {
        ...
        options: [
          ...
          "B) start",
          "C) break",
          "D) develop 2.-job/employees",
          "E) full-time",
          "F) contagious 3. aplan/relationship",
          "G) appear",
          "H) show 4. species apes/birds",
          "I) like",
          "J) through"
        ],
        answer: "D"
      ...
      },
      {
        ...
        options: [
          "A) Kokos the last gonila that can use sign language",
          "B) other apes are not as clever as Koko",
          "C) Koko isn't the only gorilla who can use sign language",
          "D) red apples are favourite food of apes AKİN DİL EĞİTİM www.tinht.com 010 420 AKIN SAG"
        ],
        answer: "C"
      }
    ],
  ...
  },
  {
    ...
    paragraphs: [
      "192 @axi Merkezi ve Yayincilik Hizmetleri ) 1 You know that you're doing something big when becomes a verb. Ask Xerox. In 1959 they created the first plain paper copy machine. It was one of the most. The company name Xerox grew into a verb that means \"to copy,\" as in \"Bob, can you Xerox this for me?\". Around 50 years later, the same thing happened to Google. Their company name grew into a verb that means \"to do an internet search.\" Now everyone and their grandma know what it means to Google it. 2 Unlike, Google wasn't the first company to invent their product. Lycos released their search engine in 1993. Yahoo! came out in Google did not come out until years later, in 1998. Although a few years difference may not seem like much, this is a major advantage in the fast moving world of tech. So how did Google do it? How did they overtake their competitors who leaders in time and money? Maybe one good idea made all the difference. 3 There are millions and millions of sites on the internet. How does a search engine know which ones are relevant to? This is a question that great minds have worked on for decades. To understand how game, you need to know how search engines worked in 1998. Back then most at the words in your query. They counted how many times those words appeared on pages. Then they showed pages where the words in your query appeared the most. This system did not work well and people often had to click through pages and pages of what they wanted. 4 Google was the first search engine that began considering links. Links are those blue underlined words that take you to other click on them. Larry Page, cofounder of Google, believed that meaningful data could be drawn from how those links connect. Page figured that websites with many links that point at them ® were more important than those that had few. He was right. Google's search results were much by far / [= much better than their rivals. They soon became the © world's most used search engine. B successful or not |. ---- a plan / the world"
    ],
    vocabulary: [
    ...
    questions: [
      {
        id: 1,
        question: "the text. 1. 4. In paragraph 1, the author's purpose is to----.",
        options: [
          ...
          "D) help readers understand if a company is successful or nat EXERCISE 4. Choose the correct option. 1.a pian/the world",
          "E) create",
          "F) examine 2.foxic gases/ an album / a prisoner",
          "G) release",
          "H) from 3.-young/nice/wrong",
          "I) damage",
          "J) seem"
        ],
        answer: "D"
      ...
      {
        id: 2,
        question: "become big by choosing the right name",
        options: [
      ...
      {
        id: 3,
        question: "successful or not In paragraph 2, the author mentions Xerox in order to —.",
        options: [
          "A) pages",
          "B) websites",
          "C) words",
          "D) Times AAKİN DİL EĞİTİM 085-422 AKIN (2546 4.pages/calories/members",
          "E) copy",
          "F) count"
        ],
        answer: "B"
      ...
      {
        id: 4,
        question: "The word “they” in paragraph refers to ----.",
        options: [
          "A) pages",
          "B) websites",
          "C) words",
  ...
  },
  {
    ...
    paragraphs: [
      "~ A)decrease B) threaten BE snr Em Airihe 8 80 Merkezi ve Yayincilik Hizmetleri Life on Mars? 1 If we tried to, could we really transform the frozen surface of Mars into something more friendly — a place where? And equally importantly, should we? 2 The first question has a clear answer: Yes, we probably could. NASA planetary scientist Chris ) McKay says, “Most of the work in ‘terraforming’ by life itself. We wouldn't have to build Mars, just modify its atmosphere”, “If we warmed it up and threw in some seeds, plants would\". Robert Zubrin, an engineer and president of the Mars Society, dreams of Martian cities. He thinks one day, we will in Mars! Zubrin believes civilisation cannot succeed if it doesn't expand limitlessly. He also thinks that if we transformed Mars, we might learn to manage our limited Earth better. He also says, if he was an astronaut, he wouldn't volunteer for journey! 4 YEAR ZERO: The thousand-year project might begin with a series of eighteen-month survey missions. Each make the six-month journey from Earth to Mars would add a small habitation module to the base. 5 100 YEARS: We could make an Earth-like atmosphere. First, we would release the carbon dioxide which is now ice. Maybe mirrors could focus sunlight on the ice to do www.okindil. com this. 200 YEARS: With, the temperature would go up and rain would fall. Algae and microbes could survive and transform the rocky surface. 7 600 YEARS: Flowering plants could be introduced would add oxygen to. Forests might even grow. on Mars, we will have ----. start to live after some climate changes? |. ---- answer / sky / sound"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "196 ____®axi Merkezi ve Yayinciltk Hizmetleri ) 1 Many people prefer \"junk food\" to healthy food because taste for it. However, trans fat raises the bad cholesterol in your body and lowers the good body needs. Fatty foods do more than cause obesity. Trans fats build up in the body and block blood flow to the heart. People whose high percentage of trans fats are at risk ] for heart diseases. 2 Trans-fat is made by adding hydrogen to liquid oil. Food companies and restaurants use trans-fat oil as it is inexpensive and makes food last longer. It also improves the taste and texture of. They became very popular in the second half of the 20th century. This is when butter got a bad name. By health care professionals, people were told margarine instead which was made from fats. Today doctors know how dangerous these processed foods are. In countries such as the US and Canada there are new government restrictions on food production. Food and beverage makers have to labels to their products. These have a list of daily recommendations and give details about all ingredients including the amount of trans-fats in a product. New York City banned trans fats from all. Even fast food chains such as McDonalds are being forced to change their. In Europe, food manufacturers have started using a voluntary labelling system at the consumers’ request. 4 We all need some fat in our diet. There are three different types of fats: saturated fats, trans fats, and unsaturated fats. Doctors recommend that of our fatty calories from unsaturated fats. Neither butter nor margarine fit in this category, though there are some spreads that contain zero trans fats. Labels are a good way to foods, but a better way is to avoid eating out. eating food with high amount of trans fats in Ereiren-S SRRRA 197"
    ],
    vocabulary: [
    ...
    questions: [
      {
        id: 1,
        question: "synonyms. 1. raise (v)",
        options: [
          "A) getting overweight",
          "B) problems with heart",
          "C) high blood pressure",
          "D) increase in bed cholesterol"
        ],
        answer: "C"
      },
      {
        id: 2,
        question: "inexpensive (adj)",
        options: [
          "A) permissions",
          "B) aims",
          "C) régulations",
      ...
      {
        id: 3,
        question: "dangerous (adj)",
        options: [
          "A) Nutrition Fact labels B food and beverage makers",
          "B) processed foods",
          "C) products ANT BIL EGITEN 1. tax the amount of/heat",
          "D) became",
          "E) lower 2. two hours/long",
          "F) last",
          "G) attach 3. smoking/the use of trans-fats",
          "H) manufacture",
          "I) ban 4. a method a medication/a tool",
          "J) force",
          "K) use"
        ],
        answer: "A"
      },
      {
        ...
        options: [
          ...
          "D) nutrition Fact laters help consumers make healthier choices EXERCISE 4. Choose the correct option EXERCISE 3. Choose the correct option according to the text."
        ],
        answer: "D"
      }
    ],
  ...
  },
  {
    ...
    paragraphs: [
      "MIXED READING PASSAGES LEVEL 2 198 ____®Axn Aerkezi ve Yayincihk Hizmetleri Fitness Pill 1 These days there are pills for just about everything. If you can't sleep, take a pill. If you're unhappy, take a pill. What about if you're overweight and you don't have time to exercise? A new fitness pill may soon. Scientists are developing a pill that provides the same benefits as exercise. According to a BBC report, the fitness pill will \"build muscle, increase stamina, and even.\" Would you take a pill if it meant you no longer needed the treadmill? Researchers found that mice who took these pills could run long-distances without. The test mice also ran almost twice as far. There is evidence that humans on these pills will also be able to build muscles without exercising. Furthermore, the research suggests that those who exercise and take the fitness pill will be even stronger. 3 Some researchers think the fitness pill will be useful in certain situations. People who cannot get out of bed due to ill health may benefit from the drug. There are also patients whose diseases cause their muscles waste away. Those with as well. Other researchers feel that the average adult might benefit from such a drug. Most adults do not get the 40 minutes of daily exercise that. The fitness pill requires no time. 4 The greatest concern about the fitness pill is in the sports world. Some will be tempted to use this drug to enhance performance. The pill has not been approved for human use yet, however, some athletes may already be drug testing before events. The renowned gold medalist swimmer, Michael Phelps, voluntarily went through extra drug testing before the 2008 Olympics. He wanted to prove to the public that his strength comes from hard work and training before the world became XERCISE 3. according to. What does “stamina” in paragraph 1 is closest in meaning to ----.?. According to the passage Michael Phelps ----. ERCISE 4. concerned / worried ---- health / your future ---- artist / region / explorer"
    ],
    vocabulary: [
    ...
    questions: [
      {
        id: 1,
        question: "the text. 4. 1. What does “stamina” in paragraph 1 is closest in meaning to ----.?",
        options: [
          "A) assistance",
          "B) profit",
          "C) interaction",
      ...
      },
      {
        ...
        options: [
          ...
          "B) encourage the reader think more deeply about what he presenta",
      ...
      },
      {
        ...
        options: [
          ...
          "C) When you are on fitness pilis, you can run faster and further.",
      ...
      {
        id: 4,
        question: "and persuasive What is the main idea of paragraph 2?",
        options: [
          "A) gets his strength and energy from fitness pills",
          "B) refused to go through extra drug testing",
          "C) owes his gold medals to herd work and training",
      ...
      {
        id: 5,
        question: "What is the author's attitude towards fitness vin pills?",
        options: [
          "A) humorous",
          "B) pessimistic",
          "C) objective",
          "D) indifferent WILD 110 κι AKST A AKIN BEL EGITIN EXERCISE 4. Choose the correct option. muscle/trust 1.",
          "E) build",
          "F) repeat people/result/species 2.",
          "G) certain"
        ],
        answer: "B"
      }
  ...
  },
  {
    ...
    paragraphs: [
      "Merkezi ve Yayincilik Hizmetleri 1 Which is the most successful animal alive today? Is it the lion, stretching in the midday African sun, or is it some insect reproducing ® millions, deep in the Amazon rainforest? A good z argument could be made for humans themselves.. But the animal that seems to have made the most of its limited opportunities is the - domestic sheep, closely followed - the horse, the pig, the cow, the dog, and all the - other / others domesticated creatures. © 2 These animals have made a huge progress similar pressures which would have wiped out some. In 1860, humans and domesticated animals represented percent of all plant and animal life, while about twenty percent, according to. The domestic animals, the ones that have made themselves fit in with the existence of, are the success stories in the history of animal development. 3 This is certain to cause an argument because central claim of the animal rights ® movement which argues that animals should have - the same right as. Domestication ie means humans profiting from animals. Humans have - simply used animals for their own selfish purposes, - using methods. The B idea of helped animals survive a revolutionary, and will probably make the animal S rights movement even angrier. Yet, there is evidence to support it. 4 But if it was animals that took the first step in the process of domestication, agreeing to live with humans on, what exactly did they get from it? Biologists argue that the driving force in all desire to ensure that they and their future generations survive, and if this is right then, wild cows and wild horses ® would / will have been wiped out if were not for domestication. ™ than that of humans in the 19\" century living with humans terms of survival strategies during the late 19\" century with humans and thus became extinct ® if they hadn't started living with humans - hadn't been domesticated - the passage? ® XERCISE 4.. =---- force behind something ---- animals / flights / market / affairs / violence. ---- progress / a claim / an argument / the most of on a voluntary / daily / part-time / temporary ---- a great / missed / rare / unique / golden ---- generate / boost / maximize ---- www.okindil.com"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "202 @®axi Merkezi ve Yayincilik Hizmetleri EE ETT—mm——————————SSS King Arthur and His Knights of the Round 1 Many places in England claim connections with King: Arthur and his Knights of the Round Table and none / neither wants to share this honour. Yet, with all high tech tools of modern archaeology, it is still impossible to know if really existed, or whether the fabulous story of men is just ) made-up. Similarly, many people wonder if the Round Table, around which Knights gathered, was a real round table. 2 In fact, Arthur's Round Table exists near Winchester. It was first described 1155 by the French poet Wace, who relied on by the guards of the mighty king. Its symbolism developed; by the 12\" century it had represented the chivalric order associated with Arthur's court. Today it which is the only part of the former Winchester Castle 3 Certainly there are plenty of King Arthur. He is known to be the British leader in the early 6\" century, who of Britain against Saxon invaders. Arthur had already become a folk hero by the 9\" century as a warrior king. But none is very reliable. What that the idea of honor associated with him was not so popular in that period of British history, known as. 4 The significance of was that no one person, not even the mighty King Arthur, would be able to sit at the head of such a table. As, it has no head, implying that everyone who sits there has equal status. A round table symbolized the concept of equality. The legend states that King Arthur ordered it to be built so that would resolve a conflict among his knights with regard to ® excess of superiority. The Round Table was therefore - built to ensure that of the Round Table were equal. - are still carrying out excavations of King Arthur and his Knights of the Round Table Arthur and the Round Table references about King Arthur exist, ----. \"XERCISE 4.. ---- natural beauty / the peace / local traditions. ---- undamaged / silent / calm. ---- information / data / person }. ----king/ universe warrior"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Bollywood and Hollywood are two internationally moognized film industries. Hollywood is basically the entire American film industry distributing. It's named after a district in California which of movie studios in the early 1900s. It was established established before WWI and is considered to be the world's leading and influential film industry. Both stars are recognized by many people around the world. Hollywood movies are made on. They usually involve elements of blood, violence, and other. In terms of. Hollywood dominates the sales. The industry earns more money by systent apart from the actual film. The movie is often ted with various other media such as and magazines. In terms of worldwide cinema, Hollywood gets around 75 per cent of all.",
      "On the other hand, Bollywood is one part of the Hindi cinema industry. The term “Bollywood” was coined and popularized during the 1970s, when Hindi cinema surpassed Hollywood. The name is a combination of. Movies created often family-oriented and appeal to. The dominant themes in these movies are musicals with large casts and several song and dance sequences. A major criticism of Bollywood movies is that they have a predictable and consistent plot. In addition, plots lack creativity and a form of escapist entertainment. Another criticism is that Bollywood replicates plots from Hollywood movies. Just as, Bollywood also produces and distributes its films internationally but does not get the same attention as. The Bollywood industry produces more films than Hollywood but spends less on production. A movie's success or earnings is reliant on and music videos that the movie produces."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Merkezi ve Yayincilik Hizmetleri Scuba Diving ) 1 Scuba diving is a type of underwater diving. Divers use a self-contained underwater breathing apparatus called scuba. Since designed to see and breathe underwater, scuba diving requires some vital equipment. Scuba divers breathe with the help of a regulator. There is another other regulator called an octopus. It is used in case of / in terms of emergency situations. Divers ) also wear a pressure gauge showing how much air is left in the air tank. Becoming / Yet, they must practise diving skills first in a closed water area. 2 Scuba diving first became the development of the Aqualung by Jacques Cousteau in the early 1940s. Articles in popular magazines about Cousteau and his underwater exploration methods brought attention to. Owing to of the equipment, diving couldn't ) widely available sport until years later. 3 There are many safety issues to consider when diving. For example, when down deeper in the water, a diver must be careful to equalize the pressure in his ears. This is done by and blowing very gently. Otherwise, the extreme pressure can cause damage ) to the middle ear and sinuses. Decompression sickness is a major concern for divers. The deeper a diver goes, the more pressure the water puts on the air inside his lungs. And, the deeper a dive, the more nitrogen gas goes into the diver's blood. For, a diver must measure the length of his dive based on its depth so as not to exceed of nitrogen absorption. When divers rise to the surface, they must carry on breathing and rise no air bubbles around them. For very deep dives, they must stop and decompress at. Therefore / Therefore, the highly pressurized air in the diver's lungs has time to leave the body before it expands -~ will expand / expands. to be taken when diving deep"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "~~ A) resembling B) different lerkezi ve Yayincilik Hizmetleri 1 Recent research has revealed that all common ancestor. Some scientists studied 504 modern languages, from Chinese, and discovered that every has stemmed from a dialect people spoke in Africa in prehistoric times. According to, they began to speak for the first time approximately 100,000 years ago and this was the first language in the world. However, it is not spoken any more. Early humans then left Africa, moving across Europe, Asia, them which then altered along. 2 Most the first humans came from Africa, but developed at different times in different parts of the world and there is no connection between them. Thus, this research is important as it suggests this is not the case. It suggests that all languages must originate from place — somewhere in Africa. The scientists made this discovery by looking at how many there were in various languages across. They discovered that the number of sounds that languages had was different in different continents. Then, they compared them with the ones in Africa, and found out a spoken language was a long way from Africa, it didn't have many sounds. However, if a language was close to Africa, it had a lot of sounds. For example, Hadza, which is spoken in Tanzania, has 69 sounds, English has about 45 sounds, and Mandarin Chinese has 32 sounds. 3 So it seems that thousands of years ago, as moving further away from, they used fewer sounds in their languages. So it seems the first language was African! Interestingly, some African languages have instance, Xu, a South African language, has 141 G different sounds. While - that are far away from Africa have many sounds, Bandjalang, an Australian language, has merely sixteen sounds. 2 world to spread their language. information |"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Vocabulary & Contrast",
    paragraphs: [
      "An overwhelming majority of the people who appear most often and most gloriously in the history books are great conquerors and soldiers, whereas really helped civilization develop are almost never mentioned at all at too. For instance, we do not know who first treated a broken leg, or calculated the length of a year, or grew crops: however addition, we do know all about the killers and destroyers. They could, but we must note that they are definitely not the most civilized ones. It is true that fighting is a part of the nature of all living things, but can we say the same for war-fighting? Animals fight, so such do savages, hence, to be good at good in the way in which an animal or a savage is good, but it is not to be civilized. People fight to settle quarrels. Fighting means killing, and civilized people ought to be able to find some way of settling their disputes other than seeing which side can kill off the greater number of the other side, and then saying that the side which has killed most has won.",
      "On, that is what the story of mankind has been ike. But we must not expect loo much. After all, the race of men has only just started. From the point of view of evolution, human beings are just babies of a ferw months old. Suppose that whole past of living creatures on hundred years; then the whole past of man works out to about one month, and during have been civilizations for between seven and eight hours. Taking mari's civilized past at about seven or eight hours, we may his future, that is to say, the whole period between now and when the sun grows too life any longer on the earth, at about one hundred thousand years Thus at the outset of its civilized life..."
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Merkezi ve Yayincilik Hizmetleri 1 From and Romans to current day writers and professors, the debate about - happiness continues. What makes someone feel? The Greek philosopher Aristotle - once said that a person's happiness stems from the » use of intelligence. Such \" religious books as the Bible - discuss faith as a form of happiness. The British <) scientist Charles Darwin believed that all species were formed way so as to enjoy happiness. People throughout history may have had ideas about happiness. Today, however/however, many people are still searching for its meaning. 2 But how do you study something like happiness? You could start with the World Database of Happiness. This set of information includes how measure happiness. Some surprising. For example, the database suggests that married people are happier than single ones. People who like to be S) with other than unsocial people. Yet - are less expected: people with children are equally as ’ happy as. And i wealthier people are only a little than poorer people. Moreover, people living / 2 lived in strongly democratic and affluent countries are happier than those who do not. This database also shows that studying happiness no theories and ideas. Economists, psychiatrists, and doctors are finding ways of understanding happiness by of information. 3 There is also an increasing amount of medical research on of happiness. Doctors can now look at happiness in a person's brain utilizing MRI. For example, an MRI can area of a person's brain is stimulated when he or she is shown. A different area of the brain becomes active when the person sees ® is seen / sees pictures of terrible subjects. This p> research may lead to better insight into depression and other mental problems. makes you happier. i. heated / fierce / intense / ongoing ----"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Merkezi ve Yayincilik Hizmetleri 1 The sinking of the Titanic on its maiden voyage has fascinated the world for more than hundred years. It has been a matter of many research studies, books, films and so on. Regardless of product, millions of people have burst into tears as they are all about a different aspect of the appalling disaster. It is a story surrounded speculation. Here are some possible scenarios. 2 The regulations controlling lifeboats that a ship should carry were inadequate in addition to obsolete regulations. In line with these regulations, the Titanic only had to have 16 lifeboats. Nobody would have died on April 14th,1912, if had enough lifeboats for all the passengers. 3 A small ship called the Californian was only 20 kilometres away from the Titanic at the time of the disaster. It had to stop for the night owing to icebergs. It was so near that could see each other's lights. The radio operator had gone away from the radio and thus since he didn't hear the distress call. Later sailors saw the Titanic's distress flares in the sky and woke up the captain but he didn't do anything as it was something important. If the Californian had realized the Titanic was sinking, it would have rescued. The captain of the Californian was later blamed for help the Titanic and his reputation was destroyed. 4 Although several warnings of icebergs from other ships in the area, the Titanic was going speed. The captain of the Titanic, like, was under great commercial pressure to make the Atlantic crossing as quickly as possible. he was not on the bridge at the © collision. Perhaps if he had been there, he would have had time to devise a plan to avoid / conserve the disaster. Captain Smith and the ship's h designer Thomas Andrews both. 2 explanations of the disaster? ® spite of his crew’s warnings pat designer, Thomas Andrews of lifeboats © XERCISE 4. strong / heavy / bitter / fierce ---- gain / acquire / earn / win a ----. ---- punishment / accidents / errors"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "Every second, about 1 hectare of the world'u rainforest is destroyed. In a year, that adds up to 31 million hectares. This alarming rate of destruction has serious consequences for. Scientists estimate that 137 species of plant and animal become extinct every day due to. Logging, however, provides jobs, profits, taxes for the government and affordable products of all, so the Canadian government is reluctant to restrict or control",
      "Much production goes lowards making pup and paper It supplies much of the world's wood pulp and newsprint paper. If could be produced in some other. Canadian forests could be preserved. Recently, a possible alternative way of producing paper has been environmentalists. a plant called hemp. Hemp has been cultivated for thousands of years. For many centuries, it was essential to the economies of many countries as make the ropes and cables used. Colonial expansion and the establishment of a world-wide trading network wouldn’t without hemp. Nowadays, scientists suggest that its cultivation should be brought back for the production of paper and pulp. According to its proponents, four times as much paper can be produced from land using hemp rather than terms of trees, and also the cultivation of hemp on could reduce the pressure on Canada's forests.",
      "However, hemp is illegal in many countries since it is related to the plant from which marijuana is produced. In the late 1930s, a movement to ban the drug marijuana resulted in not only of the plant used to produce the drug, but also of the commercial fiber-producing hemp plant. Nowadays, some people believe that it should. They argue that marijuana is not dangerous or addictive. They also point out that marijuana is less or tobacco. As a result of, in 1997, Canada legalized the farming of hemp"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "MIXED READING PASSAGES LEVEL 3 Merkezi ve Yayincilik Hizmetleri ) 1 The Eskimo people have a very interesting life style. They live in small bands, under a leader respected for provide for the group. Only the most personal property is considered private and collaboration is very important. For example, any equipment that using must go to a neighbour who needs it. In the past, the division of labour between the sexes was strict. Men hunted, whereas of the homes. However, today women take part in hunting as / too as much as men. Eskimos make use of various types of houses. Among some Eskimo groups, the snow hut, known as, is used as a winter residence. 2 As for habits, Eskimos eat a wide variety of food. They consume fish, seals, whales, and other sea mammals. Meat, fat and fish make up part of their diet. Vegetables are rarely consumed because. They don't waste any food as they depend on fishing and hunting. They sometimes eat berries, roots, stems and some other. 3 Their education takes place within the family and the community circle. By constant exposure to other adults in the community, children learn all they need to live successfully. The Eskimo of old did not have a written language, so skills and knowledge were passed down of mouth. After a successful ) hunt, for example, the details were shared with the community. The children, boys in particular, listened to reports of the hunters and learned from them. Hunters were like. They would describe in detail the location where animal and tell about the animal's behaviour and how that behaviour. Besides hunters' stories, the children would observe the behaviours of animals. As opposed to noisy children of modern society, being silent is something Eskimo children are taught as it is a necessity for hunting. Moreover, they learn to memorize the landscape and thus know the region just like an adult. ® did in the past XERCISE 4., =---= rules / regulations / orders. ---- a discussion / demonstration / celebration. ---- to sunlight / radiation / criticism / language awide/ large / great / rich ----"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Vocabulary & Contrast",
    paragraphs: [
      "Merkezi ve Yayincilik Hizmetleri Where Happiness Comes From 3 1 So many of us strive so hard for material success that you might think there is a clear relationship between wealth and happiness. The media and our governments encourage us to believe this since / since they need us to keep earning and - spending to boost economic growth.: 2 Consequently, it comes as a shock for many people - to learn that straightforward relationship between wealth and well-being. Once our basic material needs are satisfied (i.e. regular food, adequate shelter, and financial security), wealth only has a negligible effect on well-being. For example, studies have shown that in general, lottery winners do not become significantly happier than they were before, and that even extremely rich people — such as billionaires — are not significantly happier than others. Studies have shown that American and British people are less content now than they were 50 years ago, although is much higher. On an international level, there does appear to be some correlation between wealth and well-being, partly because there are many countries in the world ) where people’s basic material needs are not satisfied. But this correlation is not a straightforward one, since wealthier countries tend to be more politically stable, peaceful and democratic, with less oppression and more freedom — all of which factors in well-being. However, it does appear that there is a relationship ) between non-materialism and well-being. While material goods doesn't lead to happiness, giving these things away actually does. Generosity is strongly associated with well-being. For example, recent studies of people who practise volunteering have shown have better psychological and mental health and increased life spans. The benefits of volunteering have been found to be greater than fact, even greater than giving up smoking. 4 So if you really want to enhance your well-being — and as long as needs are satisfied — don’t try to accumulate money © in your bank account, and don't treat yourself to material goods you don't really need. Be more generous and altruistic; increase the amount of ol money you give to people in need, give more of your pu time to volunteering, or spend more time helping - other people, or behaving more kindly to everyone. achieved without being wealthy. and wealthy. ® between very rich people and others. before although they earn more now. i significantly happier. ————————————— your money that makes you more satisfied and volunteering or attending religious services. ‘XERCISE 4.. ----somebody’s confidence / morale / ego. ---= better / greater / worse. ---- solution / conclusion / settlement {. ---- matter / task / process"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "EE EEEE———————— Merkezi ve Yayincilik Hizmetleri EE EEE ———————SSSS How safe can artificial intelligence be? ) 1 Most Hollywood movies on Artificial Intelligence (Al) portray a terrifying future in which machines become so clever that even destroy us. And influential figures in this field such as and Elon Musk have called for caution. So, does this make the conquest by computers inevitable? With such a heated subject, it's worth trying to distinguish what's plausible from what's too far-fetched to worry / worrying about. For a start, we live with Al already. ) The calculations behind your Google searches or your browsing on Amazon are not just running in the background — the software is constantly learning how rapidly and usefully. 2 This is remarkable, but it is described as \"narrow\" or \"weak\" Al because work within the guidelines created by its human inventors — a crucial limitation. By contrast, \"general\" or \"strong\" Al é / which does not exist yet implies a more assertive ability to do things that go beyond the original human intentions, not just to \"think\" but also to improvise. Huge obstacles stand in the way of getting there, like mimicking how a human brain works. For a reality check, we visited NASA engineers working the most capable robots in the world. People working there over - \"| am not concerned about intelligent machines,\" said project leader Brett Kennedy. He said: \"For the foreseeable future, am not concerned, as a human. have first-hand knowledge of how hard it is for us to make a robot that does much of anything. \"To anyone worried about Al, this would be reassuring. But predicting the future pace of technology is impossible. The key and most momentous milestone — human-machine equality — is called Artificial General Intelligence, and academics are trying to assess when that might arrive and what. One is Prof Nick Bostrom, who, in his recent book, suggests that there's a 50% chance that computers could intelligence as soon as 2050. The same study says there's a 90% chance of machine-human equality by of Al — because it could help tackle climate change, energy and new medicines — but he also brings up a compelling image of mankind behaving like a curious child who has picked up an unexploded bomb, without. \"Maybe it is © decades away, but we are just as immature and naive as this child. We really don't realise the power o of this thing we are creating.\" 4 Prof Bostrom is now receiving funding from Elon Musk to explore these issues, and the aim is to z develop a shared approach to safety. We could imagine a scenario where unstoppable but the scariest scenarios ® — of robot destroyers — are somehow evaded because the right steps are taken. But then another quieter, less obvious form of takeover may still be possible. In his latest book, Prof Jerry Kaplan states that \"As we learn to trust these systems to transport us, introduce us to potential mates, customise our news, protect our property, monitor our environment, care for our children and elderly, grow, prepare and serve our food, it will be easy to miss the bigger picture.” Ultimately, there are risks, no doubt. The question is in, and soon enough. paragraph 1? z dangers of artificial intelligence. ® calculations behind Google or Amazon. not allow them the adapt for new searches. hard-to-believe Al scenarios.. According to paragraph 2, is the following. According to paragraph 3, Prof Nick Bostrom is www.okindil. com"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "224 _____@Axn Merkezi ve Yayincilik Hizmetleri How Much Would You Pay to Live for an 1 We all strive to prevent death — but at what cost does it ) become too expensive? Human life is so precious; it seems rude to put a price on it. Yet, that is the morbid decision that health services, everywhere, inevitably have to make. They have limited money to spend on sick and dying people, and available, they have to make a choice: will the few gained months, or years, be worth the money it costs? 2 Our gut instincts may seem obvious: we should do all ) that we can to buy more time for the people we love. Recently, Dominic Wilkinson, a medical ethicist, has article questioning these assumptions and asks us all to consider just has be willing to pay for a longer life. To better understand the ways we currently calculate the price of life, a closer look at his argument is needed. At the moment, drugs for terminal illnesses tend to be judged on two things — by how much they extend the lifespan, and the quality of life of the patient. From these calculations, a health service can then start to set a price on how worth the cost. The UK's recommendations, for example, are about £20,000 to £30,000 ($30,000 to $45,000) for each additional year of good health, once it has been adjusted to take into account the quality of life. This inevitably means whether been rejected by the National Health Service (NHS), because they are simply too expensive: the breast cancer drug Kadycla, for instance, only extends the lifespan by about six months for a cost of £95,000. that of life during those few months is equal to that of a healthy person, it still hugely overstretches companies should lower the costs of such treatments, and that health services should also invest more and more money in drugs Even if ill patients some more precious time. But the inevitable sacrifice is that this money will be taken away from other areas of care, that services or help for people with disabilities — measures that may be crucial for improving the quality of life for people at the start or middle of their lives. 4 “Although it's very understandable such as expensive drugs for the terminally ill, don’t think it reflects the views of the general public or to want,” Wilkonson says. “Nor is it clearly the right ethical approach.” those, and healthcare grows ever more advanced — and expensive, these issues will only become more pressing. The eminent American surgeon Atul ® Guwande has long questioned whether it is better to - stretch out the lifespan, As increasing the comfort of our available years. He ws even claimed that he instead of w extending health care at the age of 75, rather than pe entering a cycle of ever-more intense treatments to ay draw out his last few years. Few of us may decide to take such a drastic decision, but anyone, at any age, may do well to consider the value of their time g on Earth and would to ® make the most of it. the breast cancer drug Kadycl/a in order to ----. terms of lifespan and quality of the life extended high-priced although they can extend the lifespan and other countries all around the world pay to extend our lives or our loved ones ® take the money from other areas of care? pd money if they lower the costs of life-extending treatments. ® services, which will make the people in need of their lives at the cost of people who will live. ). What does “such a drastic decision” in paragraph works for terminally ill people terminally ill people life of terminally ill people |. ---- control / power / access / a degree /"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Vocabulary & Cause-Effect",
    paragraphs: [
      "~~ A) process B) frustration Merkezi ve Yayincilik Hizmetleri Why Does the Heart Want What It Wants? 1 “The heart wants what it wants.” Emily Dickinson wrote that. But why? Is it as magical as romantics believe? Is it inexplicable? This theme is evident ) beyond these pop culture references. But this is psychology, and we seek to know the “why” beneath the surface explanation. Most people would like to attribute attraction to some mystical force that. But there are some scientific explanations. 2 There are deeper, more psychoanalytic aspects of attraction. In the excellent book, A General Theory of Love, the authors discuss how our childhood leads to ) attraction to others later in life. Basically, we form strong memories from our early childhood experiences. These unconscious memories guide our attraction to others. We may not understand why we are attracted to someone, but we nonetheless. This theory explains how people find themselves attracted to someone who proves to be unhealthy for them. 3 The next aspect of attraction I'd like to discuss is the psychoanalytic idea of projection. A projection is an internal ideal, thought process, or state that is attributed to another person. in other words, the individual has an idea, unconsciously, of how they want and need their ideal mate to be, and they place these attributes and qualities into another individual. They then observe their potential partner's behaviour, and relate it to their ideal. If they do not realise that they are projecting, they then believe they have found their soul mate. however / However, as they come to know the person better, the partner begins to fall short of their expectations — falling short of expectations so consistently that / he decides the other cannot be the ideal, and often the search for the real soul mate begins again. This pattern of disappointment will continue until realises the reality of projection, and does not give in to the fantasy that they have found their soul mate. | 4 Earlier, the subtle ways that opposites attract was mentioned. For this, there is a psychological theory called compensation. In compensation, one overdoes an aspect where they feel insecure. For example, they might buy big trucks when they do not feel very manly. Compensation in regard to attraction is similar, although relates more to the choice in a partner than a weakness. Carl Jung identified El Fr 5 [rem personality traits that people tend to favour: introvert or extrovert, feeling or thinking and intuition or sensing. It is often contended that people tend to choose a partner that into balance. For example, outgoing, social people often pair with quieter, more reserved types. This may often be a function of compensation, which the attraction and emotional attachment. ® 5 Another aspect of relationships that to ignore is the bargaining process that a many go through unconsciously. This is not an x3 external, but. Each person entering a relationship is aware of the - attributes that they bring to the table. These can a include attractiveness, financial security, a quality of sweetness, intelligence, being a giving person, being attentive, considerate, and so on. Knowing brings to the table, the individual wants a comparable partner. This ® does not mean that one necessarily wants someone exactly as, nice, financially secure, and so on as he is, but it means that he wants an equal or slightly better bargain in line with what he values. Otherwise, this person might just end up getting dumped. people choose similar people. attraction is magical. © being mistaken several times. they are generally mistaken. © will think that person is your soul mate. nature of projection. feeling insecure in a relationship terms of the personality traits Jung identified process where ----, themselves and feel insecure XERCISE 4.. ---- feeling / desire / need, ---- a problem / body / face / criminal against / contrary to / above / below ---- aggressive / violent / unacceptable / inappropriate---- slow / lengthy / laborious ---- |"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Vocabulary & Argument",
    paragraphs: [
      "The Greatest Neuromyth The idea that students learn differently depending on 3) their personal preference for visual, auditory or kinaesthetic learning styles is actually just a myth. In fact, it's considered a neuromyth, which is characterised by a misunderstanding, 2 misreading, or misquoting of scientifically established facts. Other - include the idea we only use 10% of our brain, or that ” drinking less than six to eight glasses of water a day z will cause the brain to shrink.. Perhaps the most popular and influential myth is that a student learns most effectively when 3) they are taught in their preferred learning style, writes Paul Jones, professor of neuroscience at Bristol University. Indeed, studies have shown strong cross-cultural belief in this concept. In 2012, researchers asked 242 teachers from the UK and the Netherlands whether scientifically correct. The concept of auditory, visual, and kinaesthetic learning styles was the most trusted myth: Some 93% of UK teachers and 96% of Dutch teachers believed it was true. 2 In December, Philip Newton, professor at Swansea University's College of Medicine, searched about “learning styles” freely available on research databases and on get a sense of the impression a teacher might get if quick search on the subject. He found that, though studies “do not really engage” with evidence showing that learning styles is a myth, 94% of ) current research papers start with a positive view of learning styles. “Learning styles do not work, yet - moreover the current research literature is full of papers which advocate their use. This undermines ’ education as a research field and likely has a negative impact on students,” he wrote in his paper. 3 The aforementioned evidence against learning styles & is compelling. In 2004, Frank Smith, a professor of education at the University of London, ‘ conducted / has conducted research on the 13 3) most popular models of learning styles, and he found there wasn't sufficient evidence to adapt teaching techniques to various learning styles. Despite the learning styles concept “from kindergarten to graduate school,” and a “thriving industry” devoted to so many guidebooks for teachers, Smith found there wasn't rigorous and sufficient evidence for the concept. 1 In his paper on the subject, Jones argues that is not a result of fraud, scientific facts.” This is why how a false belief became so widely-held. The assumption behind learning myths seems to be based on the scientific fact that different regions of the cortex have different roles in visual, auditory, and sensory processing, so differently ® “according to which part of their brain works better.” - interconnectivity makes such an assumption unreliable.” Neuromyths arise, Jones argues, partly @ due to the technical language barrier that neuroscience papers hey difficult for non-experts, and due to the oversimplification of complicated scientific ideas.. These myths are then “promoted by victims of their - own wishful thinking,” who ® but deluded in their belief that some eccentric theory will “revolutionise science and society,” he writes. And these myths can flourish in cultures where brain are not subject to ongoing scientific scrutiny — it's rare, after all, thata classroom’s teaching methods are rigorously and scientifically tested by an observer. And finally, it seems that many people simply want to believe in these learning myths. searched for “learning styles” on the Internet in Internet on “learning styles” support the “learning styles” theory this subject with a casual search learn differently papers for people XERCISE 4. cause / be based on / correct a ---- ---- businessman / critic / member / writer a common / popular / widespread ---- ---- confidence / authority / position / credibility ---- reason / argument / case / need / desire / urge ---- testing / rules / standards / safety checks"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "230 @aAx Merkezi ve Yayincilik Hizmetleri A New and Different Pill d 1 Elysium Health, a drug company, hasn't discovered the fountain of youth, but supplement could change how you get older. Say someone came up to you selling a dietary » supplement — a pill that you take once a day — that - could boost your energy, improve your body's ability to repair its DNA, and keep you healthier as you get older. It might a ao scam, or more likely just another in a sea of d confusing, undifferentiated claims that the $20-billion-dollar supplement industry. But let's say that someone is Massachusetts Institute Technology or MIT's Lenny Guarente, one of the world's leading scientists in the field of aging research. And he's being advised by five Nobel Prize winners and two dozen other top researchers in their fields. You might pay a little more attention. 2 Co-founding a supplement company seems an unlikely career move for someone like Guarente, a man who the most well-respected scientists in his field. Mostly, for him, his getting involved in Elysium Health is a decision born out of opportunity and frustration. The opportunity is ) the chance to make a difference by the booming field of aging - research directly to consumers today. The frustration is that taken - so long in the first place. \"My biggest hope is that we can make something that - unavailable to people available, and that it will have z a positive impact on,\" Guarente says. Elysium Health actually had its beginnings in conversations between its other two, younger co-founders, Eric Marcotulli and Dan Alminana, who were then tech investors and gym buddies. They're knew they couldn't halt the march of aging and all the ailments that. Far more than diet or anything else people can control, the biggest risk factor for many of the diseases that kill us — including diabetes, cancer, and cardiovascular disease — is simply getting older. And there is nothing to stop. If anything, Elysium might make more people aware that aging is becoming something that we may one day treat. ® 4 Elysium explicitly wants to avoid the charlatan feel of the countless \"anti-aging\" products on the market r= today. It isn’t selling the pill as a key to a longer life x or to preventing any particular disease, since evidence the pill will do that. A - press release the company put out with its launch or hardly mentions aging at all. They also / © however want to appeal to young people too, who don’t necessarily care about aging, but may want to feel healthier and more energetic. Instead, the founders talk about enhancing basic biological functions: improving DNA repair, cellular detoxification, energy production, and protein function. \"We have no interest in being an anti-aging company and extending lifespan,” says Marcotulli. \"For us, this is about increasing healthspan, not lifespan.” they don’t have to get older. - employmnt for the promising young scientists industry by recruiting eminent scientists can make people feel young launching a new product:XERCISE 4.. ---- confidence / morale / sales / production ). remarkable / outstanding / exceptional ---- }. arare/ unique / golden ----"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Past Simple & Vocabulary",
    paragraphs: [
      "ee —————————————————————————————————————————————————— FT AOEA AA Aifias I%E 42 L Merkezi ve Yayincilik Hizmetleri —————————— ee —————————————————————— Isaac Newton 1 Isaac Newton rose to become the most influential scientist of the 17th century, with his ideas becoming ) the foundation of modern physics, after very humble beginnings. However, did an apple really fall on Newton's head and spur him on to - figure out gravity? Historians say there is likely not even a small amount of truth to the story. >» 2 Sir Isaac Newton was born, premature and tiny, in: 1642 in England. It's said that he didn’t excel, but he ended up studying ) law at Trinity College Cambridge, part of Cambridge University. Meanwhile, he worked as a servant to pay his bills and kept a journal about his ideas, but what got Newton interested in math? He bought a book on the subject and couldn’t. Yet, after getting his bachelor's degree in 1665; he studied math, physics, optics and astronomy on his own (due to Cambridge's being closed for a couple of years due to the plague known as the Black Death). By 1666, he had completed work on his three laws of motion. Later, he got his master's degree. His laws are still used by physics students today. For example, an object will remain in a state of inactivity unless force, or for every action, there is ) an equal and opposite reaction. 3 While known for his work on gravity, Newton was an inventor, too, but more with ideas than physical inventions. He did invent reflecting lenses for telescopes, which in a smaller telescope compared to the refracting models of the time. In his later years, he developed anti- ) counterfeiting measures for coins, including see on quarters today. Among his biggest \"inventions\" was calculus. Yes, that's right. Mere math and algebra weren't enough head, so he helped invent calculus. German mathematician Gottfried Leibniz is typically credited with developing it independently at about the same AL CRIA] cere time. It's also said that Newton invented a cat door truth of that one is a bit sketchy. There is no actual evidence that he really did invent it. 4 Urged Halley (who was studying his now-famous comet), Newton continued to study his notion of gravity and G) apply it to the motions of the Earth, Sun and Moon. It all led to his seminal work, published / - published in 1687, called the Principia — considered © by many as the greatest science book ever written. - Newton's research stopped in 1679 when / - which he had a nervous breakdown. Later, after he recovered, he spoke out against King James Il, who wanted only Roman Catholics to be in powerful governmental and academic positions. When King ® James ll was later driven out of England, Newton was elected to Parliament. He had a second breakdown in 1693, and then retired from research. Isaac Newton died in 1727. Newton's head and inspiring him to figure out 17\" century. to pay his bills at the same time. Cambridge and made him study on his own. credited with inventing the cat door on his own }. According to paragraph 4, Principia ----. however, at the time it wasn’t appreciated enough Catholics by King James Il and Newton got"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Relative Clauses & Vocabulary",
    paragraphs: [
      "Merkezi ve Yayincilik Hizmetleri 1 During the Cold War, Americans were digging holes. Lots of holes. Holes that bottled water and non-perishable food and tons and tons of concrete shelters where if Soviet bombers dropped over the country. In 1961, President Kennedy pressed Americans to protect themselves from nuclear fallout by building bomb shelters. The shelters were supposed to inhabitants from blast pressure. The reality was those shelters wouldn't do a thing to protect people from a full-scale nuclear attack. 2 Most people are familiar with fallout shelter signs left on buildings from the Cold War era. They were put in place by the Office of Civil Defense, which President Harry Truman to educate people about how to protect instance of a nuclear attack. Scientists knew, however, that released deadly gamma rays, which with enough concrete and distance underground. Radiation can literally blow over very quickly, depending on the size of the blast, so, or even the whole affected city, wouldn't burn forever. But again, that was only if you weren't directly hit by the blast. 3 The fallout shelter was one of the thickest safety blankets ever wrapped around the collective shoulders of terrified citizens. American culture embraced these ineffective methods, believing — or even a school desk — would be enough to survive full-scale nuclear attack. Typically, the shelters were \"draconian — dark, dank and dangerous,\" said Cham Dallas, director of the Institute for Disaster Management at the University of Georgia, in a phone interview. In movies like Blast from the Past, however, the bunker was romanticized as a sophisticated underground oasis, stocked with power, food, water and activities. 4 \"| think the shelter systems, public and private, were all part of a great defeat in a way,\" said Irwin Redlener, Clinical Professor of Health Policy. We thought that a nuclear war would be survivable. But it just wasn't. It was just not going to be possible.\" One theory about the origin of the fallout shelter is that the U.S. wanted it to look like it was too expensive to destroy. Evacuation plans were meant to send a message to the other side that they'd survive. However, if Soviet Union had ever called this bluff, its nuclear payload would have killed millions. 5 Nuclear blasts create shockwaves and high-speed wind that the walls off a ® house. Then comes the radiation. Some radiation, alpha particles, can't penetrate your skin. But another he form, called gamma rays, are deadly and strong enough to radiate lot of mediums, but not necessarily thick concrete. If a single Tsar Bomb, a 50 megaton thermonuclear a bomb, fell on New York City, over 10 million people power of both sides of the war were exercised, - nothing would survive. The surface would be ® radioactive for who knows how long. In 1961, the Soviet Union detonated the Tsar Bombs which had an explosive force of 50 million tons of TNT. By comparison, the bomb that hit Nagasaki, the \"Fat Man,\" had a force of only around 20,000 tons. To understand the extent of the Tsar's devastating power, consider what 500 times weaker did. Those nukes are still around. Today, the U.S. has a stockpile of around 7,100 nuclear weapons. Russia has around 7,700. Take paragraphs 1 and 27? protect themselves from the nuclear attacks ® during the 60s. survive a nuclear attack was to build bomb more informed about nuclear attacks. gamma rays in the 60s due the depth of the statement TRUE or FALSE? \"Shelters were depicted true to their originals in the movies like Blast from the Past’. XERCISE 4. ---- surroundings / voice / face / style ---- attack / war / riot / study / review ---- the way / a process / work / development ---- an attack / a crisis / war --== style / software / weapon / audience ---- effect / impact / results / consequences oo"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Past Simple & Vocabulary",
    paragraphs: [
      "EP vate AA AREER a Rai Merkezi ve Yayincihk Hizmetleri 1 It may come as a surprise to current Milton Hershey success came with the manufacture of caramel. - After / Once the failure of his Philadelphia store, - Milton headed for Denver, where he learned the art of manufacturer who insisted on using fresh milk in that. After a time in Denver, Milton once again attempted to open his own and New York City. Finally, in 1886, he went to Lancaster, Pennsylvania, where the money necessary to try again. In 1887, Hershey established the Lancaster Caramel Company, which outstanding success. Utilizing a caramel recipe which he had obtained during his previous travels, his company soared to the top. It was this business that a candy maker, and set the stage for future accomplishments. In 1893, Milton attended the Chicago International Exposition, where display of equipment was captivating. He immediately purchased it for his Lancaster candy factory and began producing chocolate, which he used for 3) coating his caramels. By the next year, production had grown 5 had grown / will have grown to include cocoa, Hershey Chocolate Company was born in 1894 as a p subsidiary of the Lancaster Caramel Company. Six years later, Milton sold the caramel company, however, he retained the rights and the equipment, to make chocolate. He believed that, lucrative market of chocolate consumers was waiting for someone to produce a reasonably priced candy. 2 Using the sale of the Lancaster Caramel Company, Hershey initially acquired farm land roughly 30 miles northwest of Lancaster, near his birthplace of Derry Church. There, he could obtain the large supplies of fresh milk needed to perfect and produce fine milk chocolate. chocolate, which at that time was a luxury product, Hershey was determined to develop a formula for milk chocolate and market and sell it to the American public. Through, he created his own formula for milk chocolate. The first ® Hershey Bar was produced the Hershey Bar with almonds was introduced in © which / what was to become the world’s largest — chocolate manufacturing company, only he didn't - know that it would z success. The facility, completed in 1905, was b designed to manufacture chocolate using the latest a mass production techniques. Hershey's Milk Chocolate quickly became the first nationally marketed product of its kind. 3 The area where located is now known as Hershey, Pennsylvania. Within the first decades of its existence, the town of Hershey thrived, school, churches, a department store, even a park and a trolley system all appeared in short order; the town soon even had a zoo. Today, a visit to the area reveals the Hershey Medical Center, the Milton Hershey School, and Hershey's Chocolate World, by a giant Peanut Butter Cup. All of these things — and a huge number of happy chocolate lovers— were made possible because minded, decisive caramel maker visited the Chicago pe Exposition of 1893! © business in Denver. a variety of countries. more equipment. due to his formula for chocolate Hershey's Chocolate World Chocolate Company"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      "ee ———————————————————————————————————————————————————— Aerkezi ve Yayincilik Hizmetleri ee —————— ee e———————————————— The Rapa Nui 1 Located in the South Pacific between Chile and Tahiti, Easter Island is one of the most isolated inhabited islands in the world. The first islanders found a green island, filled with giant palms which build boats and housing. The plants they brought with them did well in the rich volcanic soil and by AD 1550 population on a high of between 7000 and 9000. Here, in isolation some 2,300 miles west of South America and 1,100 miles from the nearest neighbouring island, the first islanders developed a distinct architectural and artistic culture. For reasons still unknown, they began carving giant statues out of volcanic rock. These monuments, known some of the most incredible ancient relics ever discovered. The people of Easter Island called themselves the Rapa Nui. Where did they come from and why did they disappear? Science has learned much about the enigma of Easter Island and has put to rest some of the more bizarre theories, though remain. 3 Darwin pointed out how groups of animals living in remote places eventually take on unique characteristics and eventually turn into distinct species. Such is the case with the people of Easter Island. Unique as a culture, the Rapa Nui left clues as to in their language, art, and beliefs. Contemporary archaeologists think it's an open and shut case: the first and only people ever to live Island were from an individual group of Polynesians. Upon, they had no contact with any other races until, that fateful day in 1722 when, on Easter Sunday, Dutch commander Jacob Roggeveen, became the first European to \"discover\" the island. What and recorded once on the island has fuelled origins of the Rapa Nui ever since. 4 The Rapa Nui’s mysterious moai statues stand in silence but speak volumes about the achievements of their creators. The stone blocks, carved, average 13 feet (4 meters) tall and 14 tons. The effort to construct these monuments and move them around the island must have been but no one aig rs © i pe knows exactly why the Rapa Nui people undertook such an incredible task. Most scholars suspect that created to honour ancestors, chiefs, or other important personages. However, no written and little oral history exists on the island, so it's impossible to be certain. This culture reached its zenith during the 10\" to 16th centuries, when carved and erected some 900 moai across the island. ® It Is generally thought that the Rapa Nui's collapse resulted from an environmental catastrophe of their were first settled; estimates range from A.D. 800 to a island ecosystem was wrecked — but a major factor appears to be the cutting of millions of giant palms to ud clear fields or make fires. It is possible that, arriving with human settlers, may have eaten “ may / should have eaten enough seeds to help to ® destroy the trees. Either way, loss of the trees exposed the island's rich volcanic soils to serious erosion. When 1722, they found the island mostly infertile and its inhabitants few. 6 Today's tourists are numerous, and most visit the Rano Raraku quarry, which used for almost all of the island's moai. The Rapa Nui's ancient inhabitants left the quarry in a fascinating condition — it is home to some 400 statues, which appear in all stages of completion. Meanwhile, across the entire island, many moai are reversing the creation process and deteriorating rapidly from priceless carvings back into plain rock. The volcanic stone is subject to weathering. Therefore, intensive conservation efforts are needed to help preserve the Rapa Nui's stone legacy in its present state. on the island culture in the 1100s Rapa Nui were left with an infertile island. ecosystem of the island. all their statues:XERCISE 4. ). common / ethnic / unknown---- {. ---- speculation / rumours / controversy / discussion |"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    theme: "Past Simple & Vocabulary",
    paragraphs: [
      "Merkezi ve Yayincilik Hizmetleri Benjamin Franklin 1 Benjamin Franklin was born on January 17, 1706 in Boston, Massachusetts. He was one of ten children born to Josiah Franklin, a soap maker, and his wife 3) Abiah Folger. Josiah wanted Benjamin to enter / to enter the clergy but could not afford to send him for schooling. Consequently, when d Benjamin was twelve, he helped his brother James who was a printer and taught Benjamin about the job.. Benjamin worked extremely hard at formatting the text - and composing publications. When Benjamin was fifteen, his brother printed the first editorial newspaper in Boston. Unlike throughout Boston that simply reprinted events, ) James’ newspaper, called The New England Courant, printed articles and editorial columns. Benjamin was very interested in his brother's newspaper and wanted to help him write it.. So, he thought of a plan. He would write under an anonymous pen-name and slip the articles under the door at night. He chose the name Silence Dogood. Articles written became very popular. People throughout Boston wanted to know who she was. She spoke out about issues abroad and the poor treatment of women. Finally, after 16 letters, Benjamin confessed to James that Dogood. James was very angry and jealous of received. 2 Nevertheless, the paper continued. James’ editorials became increasingly critical of the ) Puritan leadership within Boston, especially for their support of the smallpox inoculation (which the Franklins believed made people sicker). Due to criticisms, the police put James in prison and Benjamin was left in charge of publication. When James was released from jail, he beat Benjamin, even though been quite successful in the publication business. In 1723, Benjamin ran away and eventually ended up in Philadelphia, Pennsylvania, where met Deborah Read. While in Philadelphia, Benjamin lived with her family and soon found work as an apprentice printer. Franklin was an excellent printer and was sent of Pennsylvania to London to purchase font types and printing supplies. In exchange for service, the governor promised to help Benjamin start his own printing business. In the meantime, Benjamin and Deborah had grown very close, and she had begun to suggest they should get married. Benjamin felt unprepared, and left for England. Unfortunately, the governor had lied about helping him, and Benjamin was forced to work in London for several months. Deborah married another man while he was gone. 3 Upon Philadelphia, Benjamin borrowed money and started his own printing ® business. He worked extremely hard and soon received / received some government printing contracts. Benjamin's business became very © successful and he became well-known throughout Philadelphia. In 1730, he married Deborah Read, whose her. a 5 In the meantime, Benjamin was also carrying out » science experiments. He had already invented the - Franklin Stove, which ® keeping large houses warm in the winter, as well as glasses. He soon became interested in the concept of electricity. In 1752, Franklin devised a simple experiment to see if harnessed from a storm. He succeeded and gained international fame. 6 Soon Benjamin turned to politics to satisfy his strong desire to learn. He soon became the colonial representative for Pennsylvania, Massachusetts, Georgia and New Jersey in England. He stayed in England for 18 years, enjoying a wealthy diplomat. Although wife to join him in England, she refused and eventually died while Benjamin was in England. 7 Benjamin Franklin then came home to join the cause for independence. He was elected ® member of the Continental Congress and helped Thomas Jefferson draft the Declaration of - Independence. After he signed The Declaration of © Independence, Franklin set sail for France as BR America’s ambassador. Franklin's charm and persuasion were successful in convincing the French a to sign the 1778 Treaty of Alliance, which \" which asserted France's intention to aid the colonies in their quest for independence, and secure loans for military supplies. In 1783, Franklin attended the © signing of the Treaty of Paris, which ended the Revolutionary War. After returning, Franklin became a member of the Constitutional Convention and signed the Constitution in 1787. He died three years later on April 17, 1790. Twenty thousand people attended his funeral. articles his brother Benjamin wrote. cheated on him under arrest |. ---- a letter / poem / speech ). deal with / raise / discuss / settle ---- }. ---- access / entry / admittance"
    ],
    vocabulary: [
  ...
  },
  {
    ...
    paragraphs: [
      ". A) create B) require Merkezi ve Yayincilik Hizmetleri Are Smart Phones Manipulating Your Brain? 1 Research paper has determined that ) comes to looking at the “big picture”, the human brain is more capable of inferring broader ideas and themes from words printed on paper than those appearing on a digital screen. Between smartphones, work desktops, tablets and laptops, sometimes the only time we are ever really away from a digital screen is when a pillow. As a result of these ubiquitous glowing screens, two professors from ) Carnegie Mellon University and Dartmouth College set out to question whether by our digital habits. Their unnerving conclusion suggests AMOLEDs and LCDs of this world actually cause their readers to enter a form of tunnel vision that mental ability to think ‘outside the box’. 2 Professors Geoff Kaufman and Mary Flanagan conducted a series of tests, documented in a recent research paper. The tests compared various everyday screen-based tech — including a tablet (an iPad 2) and a laptop screen / monitor — with text printed on ordinary paper. that possible ) differences in cognitive patterns between “digital and non-digital platforms.” (II) A group of 77 subjects were tasked with various quizzes that involved problem solving and basic literary analysis. (Ill) The results across four different tests all pointed to the same conclusion that likely to consider abstract ideas (or, for want of a better phrase, read between the lines) on paper. (IV) ) 3 “Digital screens almost seem to create a sort of tunnel vision where moment, not the broader context,” Kaufman told The Washington Post. “On the iPad, they seemed not to focus or show consideration for the long-term effects of their decisions. And they just lost the game much more often.” As an example, one experiment involved a surprise exam based on by author David Sedaris. A PDF and paper version was then split between who to a surprise mock exam consisting 24 multiple-choice questions. 4 The questions were split to measure the participants’ ® “memory of specific details presented in the bo narrative”, but also their “understanding of higher-oh level inferences that the author intended readers to glean from the story”. Kaufman and Flanagan note i. digital guinea pigs score higher on memory-based, factual questions, while » traditional paper-based subjects “exhibited higher scores on the inference items”. Another lab test ® asked the participants to judge which from a specification list for two separate cars, with one being objectively superior. When faced with an “information overload”, the non-digital half again prevailed, with 66% choosing the correct car, whereas 43% of the laptop users chose the right answer. 5 Should we abandon our screens? The researchers stress in the paper that took into account the possible differences between the two platforms by keeping the font-size and layout the same for both printed and digital text. They also point out that “lack of familiarity with mobile devices” excuse would not be enough to affect ® negatively. So does this mean we should abandon E our screens immediately? Kaufman seems to think a this would be a bit drastic, yet J how his own habits could benefit those looking to avoid digital-blinkers. ps ‘XERCISE 3. according to. What is the main idea of paragraph 1? lives, they almost never part with them till they go a larger perspective than it is on a digital screen. that scientists now are conducting research on as much as words printed on paper do.. The following sentence can be added to paragraph “On the other hand, the research seems to show that passages displayed on a screen are analysed by the human brain in a mostly “factual” capacity; possibly such as “skimming” and “quick-scanning.” *XERCISE 4. |. come to / arrive at/ reach a/ n ----. ---- survey / investigation / experiment / test l. ----idea/ concept / painting / design. ---- action / measures / cuts / changes"
    ],
    vocabulary: [
