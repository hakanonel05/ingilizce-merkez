...
import {
  ...
  getAllDayStats,
  putDayStatSilently,
} from '../analytics/activityLog';

/**
 * Cihazlar arası senkronizasyon.
 *
 * ORTAK: hem katmanlı hem reading kullanır. Reading tarafı da çalışma
 * takvimi satırları üretiyor (bkz. analytics/activityLog) ve bunlar
 * yalnızca katmanlı açıldığında gönderiliyordu; sadece okuma çalışan bir
 * cihazda takvim buluta hiç çıkmıyordu.
 *
 * Tasarım kararları:
